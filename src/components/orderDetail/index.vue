<template>
  <div class="detial-wrapper">
    <div class="order-detial">
      ...
      <el-row :gutter="20">
        <el-col :span="24" class="item-tit">订单来源信息：</el-col>
        <el-col :span="14" class="item">来源应用：{{orderDetail.application_name}}</el-col>
         <el-col :span="10" class="item">站点名称：{{orderDetail.store_name}}</el-col>
      </el-row>
    </div>
...
import { orderStatus } from '@/api/config'
