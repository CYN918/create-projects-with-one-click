...
import AccountAll from './all'
import AccountObligation from './obligation'
import AccountBeshipped from './beshipped'
import AccountShipped from './shipped'
import AccountFinish from './finish'
import AccountClose from './close'
import AccountAftermarket from './aftermarket'
import AccountHandle from './handle'
...
export default {
  ...
  methods: {
    tabIndex (index) {
      ...
      this.$router.push({path:"/order/index",query:{state:index}})
    },
    toLog (id) {
      this.currentIndex = 2
