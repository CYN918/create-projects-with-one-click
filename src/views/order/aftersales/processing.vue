            ...
            <template slot-scope="scope">
              ...
              >
                ...
                <!-- <div
                  ...
                  v-if="scope.row.returnType==6 &&　(scope.row.logisticsNo == '' || scope.row.logisticsNo == null)"
                >
                  <div class="i-div">
                    <img src="../../../common/images/icon/编辑.png" alt class="operation_img" />
                  </div>
                ...
                <div
                    ...
                    v-if="(scope.row.returnType == 0 || scope.row.returnType == 6) &&　scope.row.canHandle　== 1 && scope.row.checkAfterStatus==1 && scope.row.checkRefundStatus !=null "
                    v-permit="'View:audit'"
                  >
                    <div class="i-div">
                      <img src="../../../common/images/icon/查看详情.png" alt class="operation_img" />
            ...
            <template slot-scope="scope">
              <div class="line-div small_top" style="padding-bottom: 0">
                ...
                <!-- <div
                  ...
                  v-if="((scope.row.returnType == 0 || scope.row.returnType == 1 ||  scope.row.returnType == 2) && (scope.row.returnLogisticNo== '' ||　scope.row.returnLogisticNo== null) ) || ((scope.row.returnType == 3 || scope.row.returnType == 4 ||  scope.row.returnType == 5) && scope.row.logisticsNo==null ) || (scope.row.returnType == 3 && scope.row.refundStatus ==4)"
                >
                  <div class="i-div">
