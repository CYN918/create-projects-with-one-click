          ...
          <el-table-column :resizable="false" label="操作" align="center" width="150">
            <template slot-scope="scope">
              <div :key="scope.row.afterId">
                ...
                <div class="small-Idiv" @click.stop="upgradefunc(scope.row,true)" v-if="(scope.row.supplierStatus == 4 && scope.row.agencyStatus == 4 &&　scope.row.canHandle　== 1) || (scope.row.supplierStatus == 6 && scope.row.agencyStatus == 6 &&　scope.row.canHandle　== 1) "  v-permit="'apply:complaint'">
                  <div class="i-div">
