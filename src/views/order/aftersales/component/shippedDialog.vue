                ...
                <div class="search-wrapper1">
                  ...
                  <div class="row_div">
                    ...
                    <el-row>
                      ...
                      <el-col :span="12">
                        <el-form-item label="街 道：" prop="applierAddress">
                    ...
                    <el-row>
                      ...
                      <el-col :span="12">
                        <el-form-item label="本次客诉数量：" prop="complainQuantity">
                          <el-input v-model="CommodityArr[checknum].complainQuantity" size="small" :disabled="view"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                      ...
                      <el-col :span="12">
                        <el-col :span="12">
                          <el-form-item label="运费：">
                            <el-input
                              v-model="CommodityArr[checknum].returnLogisticAmount"
                              disabled
                              type="number"
                              size="small"
                            ></el-input>
                        ...
                        <el-col :span="12">
                          <el-form-item :label="CommodityArr[checknum].logisticAmountType == 0?'客戶已付':'到付'"  label-width='100px'>
                          </el-form-item>
                        </el-col>
                      </el-col>
                      <el-col :span="12">
                        <el-form-item label="实际退款金额：" prop="describe">
                          <el-input
                            v-model="CommodityArr[checknum].finallyRefundAmount"
                            disabled
                            type="number"
                            size="small"
                          ></el-input>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        applierAddress: [{ required: true, message: "请填写详细地址", trigger: "blur" }],
        productName: [
