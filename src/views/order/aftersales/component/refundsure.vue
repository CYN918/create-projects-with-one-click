<template>
  <div>
    ...
    >
      <div>
        ...
        >
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item prop="refundUser" label="退款方式：">
                {{ruleForm.compensateType == '1'?'微信支付':'银行转账'}}
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop="openingBank" label="退款开户行：">
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item prop="refundAccount" label="退款金额：">
                 {{ruleForm.compensateAmount}}
              </el-form-item>
            </el-col>
          </el-row>
          <div class="color_div" v-if="!looktype"></div>
           <el-row  v-if="!looktype">
            <el-col :span="24">
          ...
          <el-row  v-if="!looktype">
            <el-col :span="24">
              <el-form-item prop="" label="退款凭证：" ref="picList">
                <el-upload
                  ref="loadimg"
      ...
      <span slot="footer" class="dialog-footer"  v-if="!looktype">
...
export default {
  ...
  data() {
    return {
      ...
      action:'',
      looktype:false,//true 查看 false 审核
      dialogImageUrl:'',
      title:'确认退款单',
      ruleForm: {
        picList:[],
  ...
  watch: {
    ...
    async refundsuredata(val){
      if(val.looktype){
        this.title = '查看退款单'
        this.looktype = val.looktype
      }else{
        this.looktype = false
      }
      const { data }  = await findrefunddetail(val.afterRefundId,val.complainId)
      data.picList = []
      data.comment = ''
      this.ruleForm = data
    }
