      ...
      <div class="allorder">
        <el-table :data="tableData" border stripe @row-click='aftergoodslistb'>
          ...
          <el-table-column :resizable="false" label="状态" align="center" width="80">
            <template slot-scope="scope">已完成</template>
          </el-table-column>
          ...
          <el-table-column :resizable="false" label="操作" align="center" width="150">
            <template slot-scope="scope">
              <div :key="scope.row.afterId">
                ...
                <div class="small-Idiv" @click.stop="upgradefunc(scope.row,true)" v-if="scope.row.supplierStatus == 4 && scope.row.agencyStatus == 4 &&　scope.row.canHandle　== 1" v-permit="'apply:complaint'">
                  <div class="i-div">
