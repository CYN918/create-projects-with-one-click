<template>
  <div>
      ...
      <div class="allorder">
        <el-table :data="tableData" border stripe @row-click="aftergoodslistb">
          ...
          <el-table-column :resizable="false" label="状态" align="center" width="80">
            <template slot-scope="scope">待处理</template>
          </el-table-column>
          ...
          <el-table-column :resizable="false" label="操作" align="center" width="150">
            <template slot-scope="scope">
              <div :key="scope.row.afterId">
                <div class="small-Idiv" @click.stop="DialogVisiblefunc(scope.row)" v-if="scope.row.auditComplain == 1 &&　scope.row.canHandle　== 1 "  v-permit="'checked:aftersale'">
                <div class="i-div">
              ...
              <div class="small-Idiv" @click="aftersales(scope.row,true)">
              ...
              <div class="small-Idiv" @click.stop="aftersales(scope.row)" v-if="scope.row.agencyStatus === 1 &&　scope.row.canHandle　== 1"  v-permit="'edit:compile'">
                <div class="i-div">
              ...
              <div
               ...
               v-if="scope.row.returnType == 1 &&　scope.row.canHandle　== 1 &&　(scope.row.logisticsNo == '' || scope.row.logisticsNo == null)  &&  scope.row.checkAfterStatus === 1 && scope.row.returnLogisticNo !=null  && scope.row.checkFinanceStatus == 1"
              ...
              <div
                class="small-Idiv"
                @click.stop="deliverybtn(scope.row)"
                 v-if="scope.row.returnType == 2 &&　scope.row.canHandle　== 1 &&　(scope.row.logisticsNo == '' || scope.row.logisticsNo == null) &&  scope.row.checkAfterStatus === 1  && scope.row.returnLogisticNo !=null  && scope.row.checkFinanceStatus == 1"
              ...
              <div
                class="small-Idiv"
                @click.stop="deliverybtn(scope.row)"
               v-if="scope.row.returnType == 3 &&　scope.row.canHandle　== 1 &&　(scope.row.logisticsNo == '' || scope.row.logisticsNo == null) &&scope.row.checkFinanceStatus == 1  &&  scope.row.checkAfterStatus === 1"
              ...
              <div
                class="small-Idiv"
                @click.stop="deliverybtn(scope.row)"
                v-if="scope.row.returnType == 4 &&　scope.row.canHandle　== 1 &&　(scope.row.logisticsNo == '' || scope.row.logisticsNo == null)  &&  scope.row.checkAfterStatus === 1 &&  scope.row.checkFinanceStatus== 1"
                v-permit="'Throw:mail'"
              >
                <div class="i-div">
              ...
              <div
                class="small-Idiv"
                @click.stop="deliverybtn(scope.row)"
                 v-if="scope.row.returnType == 5 &&　scope.row.canHandle　== 1 &&　(scope.row.logisticsNo == '' || scope.row.logisticsNo == null)  &&  scope.row.checkAfterStatus === 1 && scope.row.checkFinanceStatus== 1 "
              ...
              <div
               ...
               v-if="scope.row.returnType == 6 &&　scope.row.canHandle　== 1 &&　(scope.row.logisticsNo == '' || scope.row.logisticsNo == null)  &&  scope.row.checkAfterStatus === 1 && (scope.row.checkRefundStatus === null || scope.row.checkRefundStatus ==='') "
        ...
        <el-table :data="tableData2" border ref="table" stripe>
          ...
          <el-table-column :resizable="false" label="操作" align="center" width="150">
            <template slot-scope="scope">
              ...
              >
                <div class="small-Idiv" @click.stop="productfunc(scope.row)">
                  <div class="i-div">
                    <img src="../../../common/images/icon/编辑.png" alt class="operation_img" />
                  </div>
                  <span>签收退件</span>
    ...
    <returngoods :dialog="returnshow" :returndata="returndata" @closereturn="returngoods()"></returngoods>
...
import refundshow from "./component/refundshow"; //退款
import product from "./component/product"; //签收退件
import returngoods from "./component/returngoods"; //退货
...
export default {
  ...
  methods: {
    ...
    returngoods(val) {
      val
        ? ((this.returnshow = true), (this.returndata = val))
