            ...
            <div class="search-base serch-time">
              <el-row>
                ...
                <el-col :span="7" class="btn_right">
                  ...
                  <el-button type="primary" size="small" @click="deliverGoods = true" v-permit="'order:express'">快递单导入</el-button>
                </el-col>
                ...
                <el-col :span="7" class="btn_right">
                  ...
                  <el-button type="primary" size="small" @click="Detailedpush(true)"  v-permit="'detailed:push'">发货明细推送</el-button>
                </el-col>
              </el-row>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    exportOrder() {
      ...
      request({
						url: '/api/open/b/b2b2c/orderservice/order/export.json',
						method: 'post',
						responseType: 'blob',
            data:obj
					}).then(res => {
