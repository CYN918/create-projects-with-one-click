              ...
              <template slot-scope="scope" style="height:200px">
                ...
                <div class="content">
                  ...
                  >
                    ...
                    <span style="width:2150px">{{scope.row.orderType==3?'京东':scope.row.orderType==4?'网易':scope.row.orderType==5?'苏宁':scope.row.supplierName}}</span>
                ...
                <aftermarket v-if="scope.row.show" :logisticsdata='logisticsdata'></aftermarket>
              </template>
            </el-table-column>
