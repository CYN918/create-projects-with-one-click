                ...
                <el-form ref="form" :model="form" label-width="120px" size="small" style="height: 100%">
                    <div class="search-wrapper" style="height: 100%">
                            ...
                            <div style="display: flex;flex-direction: column;margin-right: 128px">
                                ...
                                <div class="search-wrapper" style="margin-bottom: 40px;">
                                    <div class="conditions" style="background-color: #f3f7fb;height: 62px;align-items: center;margin-bottom: 20px;padding-top: 15px;">
                                        ...
                                        <el-form-item label="增加运费:" style="margin-bottom: 0;float: left;" prop="continueBulkPrice" :rules="{ required: true, message: '输入框不能为空', trigger: 'blur' }">
                                            <div style="display: flex">
                        ...
                        <div style="display: flex;justify-content: center">
                            ...
                            <el-button type="primary" size="small" @click="submitForm('ruleForm')">确定新增</el-button>
                        </div>                                 
                    </div>
                </el-form>
            </div>
...
<script>
    import {getAllArea,saveTemplate} from "@/api/order/index";
    export default {
        data() {
            return {
                text: '运费规则>新增运费模板',
        ...
        methods: {
            ...
            submitForm(formName){
                ...
                let obj = {
                    ...
                    freightCalculateDetail: freightCalculateDetail
                }
                console.log(obj)
            ...
            handleCheckCity(parent, param, row, index) {
                ...
                if (param.isCheck) {
                    // console.log(1)
                    console.log(this.provinceData)
                    row.id = (row.id + '' + param.addressName).replace('undefined','');
                    let obj = {
