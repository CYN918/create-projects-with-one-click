														...
														<div style="display: flex;flex-direction: column;margin-right: 128px">
																...
																<div class="search-wrapper" v-show="showItem5" style="margin-bottom: 40px">
																		<el-table :data="list.freightFreeShipping" border
																							style="width: 100%;margin-bottom: 20px" stripe>
																				<el-table-column label="选择地区" align="center" width="600">
																						<template slot-scope="scope">
																								<!--一级省份显示 :indeterminate="isIndeterminate"-->
    ...
    export default {
        ...
        methods: {
                    ...
                    if (res.code == 200) {
                        ...
                        for (var key in this.list.freightCalculate) {
                            ...
                            this.list.freightCalculate[key] = this.list.freightCalculate[key].map(v => {
                                ...
                                if (v.def == 1) {
                                    ...
                                    //处理非默认地区的显示!!
                                    // console.log(3,v, v.freightAddress)

                                    /* const newArr = JSON.parse(JSON.stringify(this.areaData))

																		 if (this.selectedArr1.length) {
																				 this.selectedArr1.forEach(item => {
                                    ...
                                    if (v.freightAddress && v.freightAddress.length > 0) {
                                        v.freightAddress.forEach(p => {
                                            this.selectedArr[key].push(p.addressId)
                                            //当前行选中的id
                                            v.rowSelectArr.push(p.addressId)
                                            if (p.childAddress && p.childAddress.length > 0) {
                                                p.childAddress.forEach(q => {
                                                    this.selectedArr[key].push(q.addressId)
                        ...
                        if (this.list.freightFreeShipping && this.list.freightFreeShipping.length > 0) {
                            this.list.freightFreeShipping = this.list.freightFreeShipping.map(v => {
                                ...
                                //处理地区
                                v.freightAddress.forEach(p => {
                                    this.selectedArr5.push(p.addressId)
                                    //当前行选中的id
                                    v.rowSelectArr.push(p.addressId)
                                    if (p.childAddress.length) {
                                        p.childAddress.forEach(q => {
                                            this.selectedArr5.push(q.addressId)
                                            v.rowSelectArr.push(q.addressId)
                                        })
                                    }
                                })
            ...
            submitData(data) {
                ...
                table1 = obj.freightCalculate['1'].map((item) => {
                    const data1 = {
                        ...
                        model: 1,
                        def: 0,
                        operating: this.checked1 ? item.operating : 0,
                        id: item.id
                    }
                ...
                table1.push({
                    ...
                    def: 1,
                    model: 1,
                    operating: (this.checked1) ? (this.defaultfreight1.operating) : 0,
                ...
                table2 = obj.freightCalculate['2'].map((item) => {
                    const data1 = {
                        ...
                        model: 2,
                        def: 0,
                        operating: this.checked2 ? item.operating : 0,
                        id: item.id
                    }
                    data1.freightAddress = item.freightAddress.map((item2) => {
                        const data2 = {
                ...
                table2.push({
                    ...
                    def: 1,
                    model: 2,
                    operating: this.checked2 ? this.defaultfreight2.operating : 0,
                ...
                table3 = obj.freightCalculate['3'].map((item) => {
                    const data1 = {
                        ...
                        model: 3,
                        def: 0,
                        operating: this.checked3 ? item.operating : 0,
                        id: item.id
                    }
                    data1.freightAddress = item.freightAddress.map((item2) => {
                        const data2 = {
                ...
                table3.push({
                    ...
                    def: 1,
                    model: 3,
                    operating: this.checked3 ? this.defaultfreight3.operating : 0,
                ...
                table4 = obj.freightCalculate['4'].map((item) => {
                    const data1 = {
                        ...
                        model: 4,
                        def: 0,
                        operating: this.checked4 ? item.operating : 0,
                        id: item.id
                    }
                    data1.freightAddress = item.freightAddress.map((item2) => {
                        const data2 = {
                ...
                table4.push({
                    ...
                    def: 1,
                    model: 4,
                    operating: this.checked4 ? this.defaultfreight4.operating : 0,
                ...
                table5 = obj.freightFreeShipping.map((item) => {
                    ...
                    const data1 = {
                        ...
                        operating: this.checked5?item.operating:0,
                        id: item.id
                    }
                    data1.freightAddress = item.freightAddress.map((item2) => {
                ...
                if (this.deleteList5 && this.deleteList5.length) {
                    this.deleteList5.forEach(b => {
                        table5.push({
                            ...
                            model: 5,
                            def: 0,
                            operating: this.checked5?b.operating:0,
                            id: b.id,
                            freightAddress: b.freightAddress
                        })
                    })
            ...
            handleCheckProvince(param, row, index) {
                console.log(6, param, row, index)
                //全选
                if (!param.isCheck) {
                    this.selectedArr['1'].push(param.addressId)
                    //当前行选中的id
                    row.rowSelectArr.push(param.addressId)
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            this.selectedArr['1'].push(item.addressId)
                            row.rowSelectArr.push(item.addressId)
                        })
                    }
                } else {
                    const index = this.selectedArr['1'].indexOf(param.addressId) //删除全部选中的id
                    const num = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['1'].splice(index, 1)
                    if (num != -1) {
                    ...
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            // 删除父级id
                            let index2 = this.selectedArr['1'].indexOf(item.addressId)
                            this.selectedArr['1'].splice(index2, 1)
            ...
            handleCheckCity(parent, param, row, index) {
                ...
                if (param.isCheck) {
                    ...
                    const index3 = this.selectedArr['1'].indexOf(param.addressId) //删除选中的id
                    const num3 = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['1'].splice(index3, 1)
                    if (num3 != -1) {
                        row.rowSelectArr.splice(num3, 1)
                    }
                }
                // console.log(3344,this.selectedArr['1'],row.rowSelectArr)
                /*-------------------------------------------------------------------*/
                row.origin_list = row.freightAddress
            },
            //点击编辑按钮
            showCheckedArea(row, index) {
                console.log(2, this.areaData)
                const newArr = JSON.parse(JSON.stringify(this.areaData))

                console.log(3, this.selectedArr['1'])
                console.log(4, row.rowSelectArr)

                if (this.selectedArr['1'].length) {
                    this.selectedArr['1'].forEach(item => {
                        this.deleteelement(item, newArr, index) //删除掉所有选中的数据
                    })
                }
                ...
                if (row.rowSelectArr.length) {
                    row.rowSelectArr.forEach(val => {
                        this.addelement(val, secondArr, newArr, index) //添加当前行已经选中的数据
                    })
                }
                // console.log(777, newArr)
                row.freightAddress = newArr
            ...
            //添加id相同的属性
            addelement(val, arr, newArr, index) {
                    ...
                    if (arr[i].addressId == val) {
                        ...
                        if (arr[i]) {
                            if (arr[i].childAddress && arr[i].childAddress.length > 0) {
                                ...
                                this.addelement(val, arr[i].childAddress, newArr.childAddress)
                                /*问题:市选能实现,全选实现不了!!*/
                                /*for (let t in arr[i].childAddress) {
                                    if (arr[i].childAddress[t].addressId == val) {
                                        arr[i].childAddress[t].isCheck = true
                                        if (newArr[i]) {
                                            if (newArr[i].childAddress && newArr[i].childAddress.length > 0) {
                                                newArr[i].childAddress.splice(t, 0, arr[i].childAddress[t]);
                                                // newArr.push(arr[i])
                                            }
                                        }
            ...
            add() {
                ...
                if (this.list.freightCalculate['1'] && this.list.freightCalculate['1'].length > 0) {
                    this.list.freightCalculate['1'].push(newValue);
                } else {
                    this.$set(this.list.freightCalculate, '1', [])
                    this.list.freightCalculate['1'].push(newValue);
                }
            },
            //点击删除按钮
            ...
            handleCheckProvince2(param, row, index) {
                ...
                //全选
                if (!param.isCheck) {
                    this.selectedArr['2'].push(param.addressId)
                    //当前行选中的id
                    row.rowSelectArr.push(param.addressId)
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            this.selectedArr['2'].push(item.addressId)
                            row.rowSelectArr.push(item.addressId)
                        })
                    }
                } else {
                    const index = this.selectedArr['2'].indexOf(param.addressId) //删除全部选中的id
                    const num = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['2'].splice(index, 1)
                    if (num != -1) {
                        row.rowSelectArr.splice(num, 1)
                    }
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            // 删除父级id
                            let index2 = this.selectedArr['2'].indexOf(item.addressId)
                            this.selectedArr['2'].splice(index2, 1)
                            let num2 = row.rowSelectArr.indexOf(item.addressId)
                            if (num2 != -1) {
                                row.rowSelectArr.splice(index2, 1) //删除子级id
                            }
            ...
            handleCheckCity2(parent, param, row, index) {
                ...
                if (param.isCheck) {
                    ...
                    const index3 = this.selectedArr['2'].indexOf(param.addressId) //删除选中的id
                    const num3 = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['2'].splice(index3, 1)
                    if (num3 != -1) {
                        row.rowSelectArr.splice(num3, 1)
                    }
                }
                // console.log(3344,this.selectedArr['2'],row.rowSelectArr)
                /*-------------------------------------------------------------------*/
                row.origin_list = row.freightAddress
            },
            //点击编辑按钮
            showCheckedArea2(row, index) {
                ...
                if (this.selectedArr['2'].length) {
                    this.selectedArr['2'].forEach(item => {
            ...
            add2() {
                ...
                this.$set(newValue, 'rowSelectArr', []) //当前行选中数据id
                // this.$set(newValue, 'operating', 1) //状态：0:删除，1:新增，2:更新
                if (this.list.freightCalculate['2'] && this.list.freightCalculate['2'].length > 0) {
                    this.list.freightCalculate['2'].push(newValue);
                } else {
                    this.$set(this.list.freightCalculate, '2', [])
                    this.list.freightCalculate['2'].push(newValue);
                }
                // console.log(this.list.freightCalculate['2'])
            },
            //点击删除按钮
            ...
            handleCheckProvince3(param, row, index) {
                ...
                //全选
                if (!param.isCheck) {
                    this.selectedArr['3'].push(param.addressId)
                    //当前行选中的id
                    row.rowSelectArr.push(param.addressId)
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            this.selectedArr['3'].push(item.addressId)
                            row.rowSelectArr.push(item.addressId)
                        })
                    }
                } else {
                    const index = this.selectedArr['3'].indexOf(param.addressId) //删除全部选中的id
                    const num = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['3'].splice(index, 1)
                    if (num != -1) {
                        row.rowSelectArr.splice(num, 1)
                    }
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            // 删除父级id
                            let index2 = this.selectedArr['3'].indexOf(item.addressId)
                            this.selectedArr['3'].splice(index2, 1)
                            let num2 = row.rowSelectArr.indexOf(item.addressId)
                            if (num2 != -1) {
                                row.rowSelectArr.splice(index2, 1) //删除子级id
                            }
            ...
            handleCheckCity3(parent, param, row, index) {
                ...
                if (param.isCheck) {
                    ...
                    const index3 = this.selectedArr['3'].indexOf(param.addressId) //删除选中的id
                    const num3 = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['3'].splice(index3, 1)
                    if (num3 != -1) {
                        row.rowSelectArr.splice(num3, 1)
                    }
                }
                // console.log(3344,this.selectedArr['3'],row.rowSelectArr)
                /*-------------------------------------------------------------------*/
            ...
            showCheckedArea3(row, index) {
                ...
                if (this.selectedArr['3'].length) {
                    this.selectedArr['3'].forEach(item => {
            ...
            add3() {
                ...
                if (this.list.freightCalculate['3'] && this.list.freightCalculate['3'].length > 0) {
                    this.list.freightCalculate['3'].push(newValue);
                } else {
                    this.$set(this.list.freightCalculate, '3', [])
                    this.list.freightCalculate['3'].push(newValue);
                }
            },
            //点击删除按钮
            ...
            handleCheckProvince4(param, row, index) {
                ...
                //全选
                if (!param.isCheck) {
                    this.selectedArr['4'].push(param.addressId)
                    //当前行选中的id
                    row.rowSelectArr.push(param.addressId)
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            this.selectedArr['4'].push(item.addressId)
                            row.rowSelectArr.push(item.addressId)
                        })
                    }
                } else {
                    const index = this.selectedArr['4'].indexOf(param.addressId) //删除全部选中的id
                    const num = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['4'].splice(index, 1)
                    if (num != -1) {
                        row.rowSelectArr.splice(num, 1)
                    }
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            // 删除父级id
                            let index2 = this.selectedArr['4'].indexOf(item.addressId)
                            this.selectedArr['4'].splice(index2, 1)
                            let num2 = row.rowSelectArr.indexOf(item.addressId)
                            if (num2 != -1) {
                                row.rowSelectArr.splice(index2, 1) //删除子级id
                            }
            ...
            handleCheckCity4(parent, param, row, index) {
                ...
                if (param.isCheck) {
                    ...
                    const index3 = this.selectedArr['4'].indexOf(param.addressId) //删除选中的id
                    const num3 = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['4'].splice(index3, 1)
                    if (num3 != -1) {
                        row.rowSelectArr.splice(num3, 1)
                    }
                }
                // console.log(3344,this.selectedArr['4'],row.rowSelectArr)
                /*-------------------------------------------------------------------*/
                // row.freightAddress = row.dataList
                row.origin_list = row.freightAddress
            },
            ...
            showCheckedArea4(row, index) {
                ...
                if (this.selectedArr['4'].length) {
                    this.selectedArr['4'].forEach(item => {
            ...
            add4() {
                ...
                if (this.list.freightCalculate['4'] && this.list.freightCalculate['4'].length > 0) {
                    this.list.freightCalculate['4'].push(newValue);
                } else {
                    this.$set(this.list.freightCalculate, '4', [])
                    this.list.freightCalculate['4'].push(newValue);
                }
            },
            //点击删除按钮
            ...
            handleCheckProvince5(param, row, index) {
                ...
                //全选
                if (!param.isCheck) {
                    this.selectedArr['5'].push(param.addressId)
                    //当前行选中的id
                    row.rowSelectArr.push(param.addressId)
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            this.selectedArr['5'].push(item.addressId)
                            row.rowSelectArr.push(item.addressId)
                        })
                    }
                } else {
                    const index = this.selectedArr['5'].indexOf(param.addressId) //删除全部选中的id
                    const num = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['5'].splice(index, 1)
                    if (num != -1) {
                        row.rowSelectArr.splice(num, 1)
                    }
                    if (param.childAddress.length) {
                        param.childAddress.forEach(item => {
                            // 删除父级id
                            let index2 = this.selectedArr['5'].indexOf(item.addressId)
                            this.selectedArr['5'].splice(index2, 1)
                            let num2 = row.rowSelectArr.indexOf(item.addressId)
                            if (num2 != -1) {
                                row.rowSelectArr.splice(index2, 1) //删除子级id
                            }
            ...
            handleCheckCity5(parent, param, row, index) {
                ...
                if (param.isCheck) {
                    ...
                    const index3 = this.selectedArr['5'].indexOf(param.addressId) //删除选中的id
                    const num3 = row.rowSelectArr.indexOf(param.addressId) //删除当前行的id
                    this.selectedArr['5'].splice(index3, 1)
                    if (num3 != -1) {
                        row.rowSelectArr.splice(num3, 1)
                    }
                }
                // console.log(3344,this.selectedArr['5'],row.rowSelectArr)
                /*-------------------------------------------------------------------*/
                row.origin_list = row.freightAddress
            },
            //点击编辑按钮
            showCheckedArea5(row, index) {
                ...
                if (this.selectedArr['5'].length) {
                    this.selectedArr['5'].forEach(item => {
            ...
            add5() {
                ...
                if (this.list.freightFreeShipping && this.list.freightFreeShipping.length > 0) {
                    ...
                    this.$set(this.list.freightFreeShipping, [])
                    this.list.freightFreeShipping.push(newValue);
                }
            },
            //点击删除按钮
