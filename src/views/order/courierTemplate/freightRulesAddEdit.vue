<template>
		<div class="margin" style="height: 100%">
				...
				<div class="mbottom">
						<div class="goods-fitter">
								<div class="search-wrapper1" style="height: 100%;display: flex;align-items: flex-start;flex-direction: column">
										...
										<div style="display: flex;justify-content: flex-start;margin-left: 180px">
												...
												<el-button type="primary" size="small" @click="newAdd">保存</el-button>
										</div>
