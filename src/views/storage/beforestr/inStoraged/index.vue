  ...
  <div class="margin0">
      ...
      <div class="goods-fitter">
        <el-form label-width="100px" size="small">
          <div class="search-wrapper">
            <h4 class="title">已入库</h4>
            <div class="search-base">
              <el-row>
               <el-col :span="5">
                    <el-col>
                        <el-form-item label="客户平台：">
                            <el-col :span="21">
     ...
     <div class="tabs-header">
        <ul class="clearfix">
            ...
            <li class ="link" @click="tabIndex0(0)"  :class="currentIndex0===0 ? 'active' : ''">全部交货</li>
  
            <li class ="link" @click="tabIndex0(1)"  :class="currentIndex0===1 ? 'active' : ''">今日交货</li>
  
          <li class ="link" @click="tabIndex0(2)"  :class="currentIndex0===2 ? 'active' : ''">3日内交货</li>

            <li class ="link" @click="tabIndex0(3)"  :class="currentIndex0===3 ? 'active' : ''">7日内交货</li>
...
import {getInStoragedList} from "@/api/purchase/index"
