 ...
 <div> 
   <div class="mcard" style="border:1px solid #d7e0f1">
      <el-table :data="storageList" border @selection-change="handleSelectionChange" stripe>
        ...
        <el-table-column label="安全库存" prop="name" align="center" >
                    <template slot-scope="scope">
                        {{scope.row.safeQuantity}}
                  </template> 
        </el-table-column>
        ...
        <el-table-column label="存货缺口" prop="name" align="center" >
                    <template slot-scope="scope">
                        {{scope.row.gapQuantity}}
                  </template>
        </el-table-column>
