            ...
            <div class="mcard"> 
             ...
             <div class="auditBody2" :class="!personList.userName&&!personList.thisUserName?'auditShow':''">
                <div class="auditHeader" style="margin-top:0;">
                    ...
                    <span class="white" v-if="!personList.thisUserName">无</span>
                    <span class="gray">部门 </span>
                    <span class="white" v-if="personList.thisOrganizeName">{{personList.thisOrganizeName}}</span>
                    <span class="white" v-if="!personList.thisOrganizeName">无</span>
                    <span class="gray">职位 </span>
                    <span class="white" v-if="personList.thisPosition">{{personList.thisPosition}}</span>
                    <span class="white" v-if="!personList.thisPosition">无</span>
                </div>
                <div class="auditContent">
...
import {stockAuditTimeLine,stockApproval} from '@/api/storage/index'
  ...
  components:{
   ...
   computed: {
    ...
    submitAudit(){
      ...
      obj.id = this.transferBillId;
      stockApproval(obj).then(res=>{
        if(res.code===200){
     ...
     //进度表
      Audit(){
        this.transferBillNo = this.editDatas.transferBillNo;
        stockAuditTimeLine(this.transferBillId).then(res=>{
          if(res.code===200){ 
