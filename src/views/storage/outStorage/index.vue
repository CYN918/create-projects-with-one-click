     ...
     <div class="margin">
      <div class="tabs-header">
        <ul class="clearfix">
            ...
            <li class ="link" @click="tabIndex0(0)"  :class="currentIndex0===0 ? 'active' : ''">待出库</li>
            <li class ="link" @click="tabIndex0(3)"  :class="currentIndex0===3 ? 'active' : ''">销售出货清单</li>
            <li class ="link" @click="tabIndex0(1)"  :class="currentIndex0===1 ? 'active' : ''">生成出库单</li>
            <li class ="link" @click="tabIndex0(2)"  :class="currentIndex0===2 ? 'active' : ''">已出库</li>
...
import OutStoraged from './outStoraged'
