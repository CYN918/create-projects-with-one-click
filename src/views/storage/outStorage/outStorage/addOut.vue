                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item label="送 货 员：" prop="transportMode">
                      <el-col :span="19">
                        <el-input
                          v-model="OrderData.deliveryUserName"
                          v-if="userList.length<1"
                          readonly
                        ></el-input>
                        <el-select
                          v-model="form.deliveryUserId"
                          placeholder="请选择"
                          v-if="userList.length>=1"
                          style="width:100%"
                    ...
                    <div class="mcard" style="padding-bottom:0">
                      <el-table :data="OrderData.details" border style="width: 100%" stripe>
                        ...
                        <el-table-column
                          ...
                          width="100"
                        >
                          <template slot-scope="scope">{{scope.row.unstockeQuantity}}</template>
                        </el-table-column>
                        <el-table-column
                          prop="commonContactDept"
                          label="本次出货数量"
...
export default {
  ...
  data() {
    return {
      ...
      options: [{ value: 1, label: "公司" }, { value: 2, label: "物流" }],
      formData: {
        current_page: 1,
        page_size: 2,
        total_count: 0
