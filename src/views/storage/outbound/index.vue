  ...
  <div class="margin">
                ...
                <el-col :span="5">
                  <el-col>
                    <el-form-item label="联系人：">
                        <el-col :span="23">
                            <el-input v-model="form.price_min" placeholder="请输入姓名或联系电话"></el-input>
                        </el-col>
                    </el-form-item>
                  </el-col>
                </el-col>
                <el-col :span="5">
                  <el-col>
                    <el-form-item label="部门：">
                        <el-col :span="23">
                            <el-input v-model="form.price_min" placeholder="请输入部门"></el-input>
                        </el-col>
                    </el-form-item>
                  </el-col>
                </el-col>
    ...
    <div class="mcard">
        <el-row class="operate mbottom">
            <el-col :span="21">
                ...
                <el-button type="primary" size="small">全部需出库</el-button>
                <el-button type="primary" size="small">今日需出库</el-button>
                <el-button type="primary" size="small">3天内需出库</el-button>
                <el-button type="primary" size="small">7天内需出库</el-button>
        </el-col>
        <el-col :span="3">
        </el-col>
        </el-row>
      <el-table :data="tableData" border @selection-change="handleSelectionChange" stripe>
        ...
        <el-table-column label="出库状态" prop="name" align="center"></el-table-column>
        <el-table-column label="发货状态" prop="name" align="center"></el-table-column>
        ...
        <el-table-column label="销售订单" prop="name" align="center"></el-table-column>
        <el-table-column label="销售出货清单" prop="name" align="center"></el-table-column>
        ...
        <el-table-column label="发货信息" prop="name" align="center"></el-table-column>
        <el-table-column label="附件1" prop="name" align="center"></el-table-column>
        <el-table-column label="附件2" prop="name" align="center"></el-table-column>
      </el-table>
    ...
    <div class="mcard" style="margin-top:20px">
      ...
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        ...
        <el-table-column  prop="name"  label="出库仓库" align="center"></el-table-column>
        <el-table-column  prop="name"  label="本次出库数量" align="center"></el-table-column>
    </el-table>
      <div class="pagination">
        <el-pagination
            @size-change="handleSizeChange"
