  ...
  <div class="margin">
    ...
    <div class="mcard">
      ...
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        ...
        <el-table-column  prop="name"  label="资金账号" align="center"></el-table-column>
        <el-table-column  prop="name"  label="当前余额" align="center"></el-table-column>
        <el-table-column  prop="name"  label="户名" align="center" ></el-table-column>
        <el-table-column  prop="name"  label="银行名称" align="center"></el-table-column>
        <el-table-column  prop="name"  label="开户行地址" align="center"></el-table-column>
