  ...
  <div class="margin">
    ...
    <div class="mcard">
      ...
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        <el-table-column  prop="name"  label="供应商名称" align="center" width="55"></el-table-column>
        ...
        <el-table-column  prop="name"  label="采购订单个数" align="center"></el-table-column>
        <el-table-column  prop="name"  label="订单金额" align="center" ></el-table-column>
        <el-table-column  prop="name"  label="已付款金额" align="center"></el-table-column>
        <el-table-column  prop="name"  label="未付款金额" align="center"></el-table-column>
    </el-table>
    ...
    <el-row>
        ...
        <div class="mcard" style="margin-top:20px;margin-right: 20px;" >
          <el-row>
                ...
                <el-table   :data="tableData"  border style="width: 100%" stripe>
                  ...
                  <el-table-column  prop="name"  label="订单金额" align="center"></el-table-column>
                  <el-table-column  prop="name"  label="已付金额" align="center"></el-table-column>
                  <el-table-column  prop="name"  label="未付金额(应收)" align="center"></el-table-column>
      ...
      <el-row>
            ...
            <el-table   :data="tableData"  border style="width: 100%" stripe>
              ...
              <el-table-column  prop="name"  label="支出金额" align="center"></el-table-column>
