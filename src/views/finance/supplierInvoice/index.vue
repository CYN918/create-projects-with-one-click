                ...
                <el-col :span="5">
                  <el-col>
                    <el-form-item label="供应商名称：">
                        <el-col :span="23">
                            <el-input v-model="form.price_min" placeholder="请输入供应商名称"></el-input>
                        </el-col>
                    </el-form-item>
                  </el-col>
                </el-col>
                ...
                <el-col :span="5">
                  <el-col>
                    <el-form-item label="采购单号：">
                        <el-col :span="23">
                            <el-input v-model="form.price_min" placeholder="请输入采购单号"></el-input>
                        </el-col>
                    </el-form-item>
                  </el-col>
                </el-col>
    ...
    <div class="mcard">
      <el-row class="operate mbottom">
        <el-col :span="21">
            ...
            <el-button type="primary" size="small" >查看采购合同</el-button>
        </el-col>
        <el-col :span="3">
        </el-col>
      </el-row>
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        ...
        <el-table-column  prop="name"  label="收票公司" align="center"></el-table-column>
        <el-table-column  prop="name"  label="收票人" align="center"></el-table-column>
