  ...
  <div class="margin dealerlist">
    ...
    <div class="wrapper">
      ...
      <el-table
        ...
        <el-table-column type="index" label="编号" align="center" width="55">
        ...
        <el-table-column label="商品规格" align="center" width="150">
          <template slot-scope="scope">
        ...
        <el-table-column label="库存(PCS)" align="center" width="150">
          <template slot-scope="scope">
            <el-input class="txt_left" type="number" v-model="scope.row.bgGoodsSkuReturnList[scope.row.index].goodsNumber"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="供应商活动价" align="center" width="150">
          <template slot-scope="scope">
            <el-input class="txt_left" type="number" v-model="scope.row.bgGoodsSkuReturnList[scope.row.index].supplierActivityPrice"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="商城活动价" align="center" width="150">
          <template slot-scope="scope">
            <el-input class="txt_left" type="number" v-model="scope.row.bgGoodsSkuReturnList[scope.row.index].fyuanaiActivityPrice"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="经销商结算价" align="center" width="150">
          <template slot-scope="scope">
            <el-input class="txt_left" type="number" v-model="scope.row.bgGoodsSkuReturnList[scope.row.index].distributorActivityPrice"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="平台活动价" align="center" width="150">
          <template slot-scope="scope">
            <el-input class="txt_left" type="number" v-model="scope.row.bgGoodsSkuReturnList[scope.row.index].platformActivityPrice"></el-input>
          </template>
        </el-table-column>
...
import { reqActivityProList, reqActivityProClassify, updateActivityPro, deleteActivityPro } from '@/api/activity/index'
