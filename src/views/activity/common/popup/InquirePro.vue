    ...
    checkProType(type) {
      switch (type) {
        case '0': // 全部
          break
        case '1': // 京东
          this.parameter.sourceType = 1
          break
        case '2': // 苏宁
          this.parameter.sourceType = 3
          break
        case '3': // 网易
          this.parameter.sourceType = 2
          break
        case '4': // 一件代发
          this.parameter.isSubstituteSales = 1
          break
        case '5': // 集采商品
          this.parameter.isVolume = 1
          break
        case '6': // 虚拟商品
          this.parameter.isReal = 2
          break
        default :
      }
      this.getProductList()
