...
<script>
  ...
  import { updataActivityProExamineStatus, reqActivityProList, reqActivityProClassify, updateActivityPro, deleteActivityPro } from '@/api/activity/index'
