						...
						<el-table :data="list" border style="width: 100%" stripe>
								...
								<!--<el-table-column label="操作" align="center" fixed="right" width="180">
										<template slot-scope="scope">
												<div class="line-div">
														<div class="small-Idiv" @click="detail(scope.row.auditId,1)" style="margin-right:10px">
																<div class="i-div">
...
<script>
    import {deleteTellGoods2, getTellGoodsNoticeList} from '@/api/tellGoods/index'
    ...
    export default {
        ...
        methods: {
            //获取表格数据
            getDataList() {
                getTellGoodsNoticeList(this.form).then(res => {
