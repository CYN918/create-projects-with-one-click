						...
						<el-table :data="list" border style="width: 100%" stripe>
								...
								<el-table-column label="操作" align="center" fixed="right" width="180">
										<template slot-scope="scope">
												...
												<div class="line-div" v-if="showGoodsRecommend">
...
<script>
    import {deleteTellGoods2, gettellGoodsRecommendList} from '@/api/tellGoods/index'
    ...
    export default {
        ...
        methods: {
            ...
            //获取表格数据
            getDataList() {
                gettellGoodsRecommendList(this.form).then(res => {
                    ...
                    console.log(666, this.list)
										this.list.forEach(item=>{
										    this.showGoodsRecommend = item.reportPlan !== 7;
										})
                })
            },
            // 查看详情
