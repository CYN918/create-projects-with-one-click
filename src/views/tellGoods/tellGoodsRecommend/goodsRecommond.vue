										...
										<div class="search-wrapper">
												...
												<el-table
														...
														<el-table-column align="center" label="商城价">
																<template slot-scope="scope">
																		<!--{{scope.row.lowestPrice+'-'+scope.row.highestPrice}}-->
																		<div v-if="scope.row.skuInfo[0].priceInfo">
										...
										<el-form ref="form" :model="form3" label-width="120px" size="small">
												<div class="search-wrapper">
														...
														>
																...
																<el-table-column label="价格信息" align="center" width="160">
																		<template slot-scope="scope">
																				<div class="txt_left">
        ...
        methods: {
            ...
            _getGoods() {
                getGoods(this.form3).then(res => {
                    ...
                    this.form3.current_page = res.data.page.pageIndex
                    this.form3.page_size = res.data.page.pageSize
                    this.loading = false
            ...
            submitData() {
                ...
                obj.skuChooseInfo = []
                obj.skuChooseInfo = this.multipleTableData2.map(v => {
                    const data = {
                        goodId: v.goodsId,
                    }
                    v.skuInfo.forEach(item=>{
                        data.skuId=item.skuId
										})
                    return data
                })
								console.log(55,obj.skuChooseInfo)
                ...
                submitRecommondGood(obj).then(res => {
                    if (res.code == 200) {
                        ...
                        this.$message.success('提交成功')
												this.$router.push({name:'tellGoodsRecommend'})
                    } else {
