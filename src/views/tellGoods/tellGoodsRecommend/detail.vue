								...
								<el-form ref="form" :model="form" label-width="120px" size="small">
										<div class="search-wrapper">
												...
												<el-row :gutter="10">
														...
														<el-col :span="6">
																<el-form-item label="部门:" style="width:70%">
																		{{form.department}}
																</el-form-item>
														</el-col>
														<el-col :span="6">
										...
										<div class="search-wrapper">
												...
												<el-table
														...
														<el-table-column align="center" label="操作" width="180px">
																<template slot-scope="scope">
																		<div class="small-Idiv" @click="checkDetail(scope.row.superReportId)">
																				<div class="i-div">
...
<script>
    import {get_show_goods, get_show_goods2, getDetailGoods, up_goods} from '@/api/tellGoods/index'
    ...
    export default {
        ...
        methods: {
            ...
            //查看详情??
            checkDetail(superReportId) {
                this.$router.push({name: 'goodsDetail', query: {id: superReportId}})
            },
            //删除
            ...
            uploadGoods(supReportGoodsIds) {
                ...
                if (supReportGoodsIds) {
                    up_goods(supReportGoodsIds).then(res => {
                        if (res.code == 200) {
