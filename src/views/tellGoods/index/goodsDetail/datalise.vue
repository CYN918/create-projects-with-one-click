            ...
            <div class="search-wrapper">
                ...
                <el-form ref="form" label-width="150px" size="small">
                  <el-form-item label="商品名称：" prop="goods_name">
                    <el-select v-model="form.value" filterable  placeholder="请选择" disabled @change="getAttribute" style="width:300px">
                      <el-option
                  ...
                  <el-form-item :label="item.attrName+'：'" prop="goods_name" v-for="item in dataArr" :key="item.attrId">
                    <el-input placeholder="请输入"  style="width:300px" v-model="item.value" disabled  v-if="item.attrInputType == 0"></el-input>
                    <el-select  filterable  placeholder="请选择"  v-if="item.attrInputType == 1" disabled v-model="item.value"  style="width:300px">
                      <el-option
                    ...
                    <el-input placeholder="请输入" type="textarea" :rows="2" v-if="item.attrInputType == 3" disabled v-model="item.value"  style="width:300px"></el-input>
                  </el-form-item>
                </el-form>
            </div>
        </div>
...
<script>
    import {findTypeValue, getItemtypes} from '@/api/product/index'
