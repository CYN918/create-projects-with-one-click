      ...
      <div class="mbottom">
        <div class="goods-fitter">
          <div class="search-wrapper">
            ...
            <el-row>
              <el-col :span="7">
                <el-form-item label="登录账号:">{{form.sysuserAccount}}</el-form-item>
              </el-col>
              <el-col :span="8">
            ...
            <el-row>
              <el-col :span="7">
                <el-form-item label="用户名:">{{form.sysuserName}}</el-form-item>
              </el-col>
              <el-col :span="8">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="部门:">
                  <span>{{form.organize.description?form.organize.description:''}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
              <el-col :span="7">
                <el-form-item label="是否已婚:" prop="resource">
                  <span>{{form.maritalStatus==0?'未婚':'已婚'}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
...
<script>
import { getSysuerId, getSysuserByIdList } from "@/api/permissions/index";
...
export default {
  ...
  mounted() {
    ...
    getSysuserByIdList(this.sysuserId).then(res => {
      if (res.code == 200) {
        this.form = res.data;
      }
    });
