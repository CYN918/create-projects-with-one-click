      ...
      <div class="mcard">
        <el-row class="operate mbottom">
            ...
            <!-- <el-button type="primary">仅挑选</el-button> -->
              <el-button type="primary" @click="addCatagory">新增</el-button>
              <el-button type="primary" @click="addCatagory">编辑</el-button>
              <el-button type="primary" @click="addCatagory">删除</el-button>
        ...
        <el-table  :data="data"
            ...
            <el-table-column  prop="catName" label="部门名称"   align="center"> </el-table-column>
            <el-table-column  prop="userName" label="启用"   align="center"></el-table-column>
        </el-table>
