      ...
      <div class="mcard">
        ...
        <el-table  :data="data"
            ...
            border>
                ...
                <el-table-column  prop="catName" label="序号" width="55"   align="center"> </el-table-column>
              <el-table-column  prop="catName" label="变量标题"   align="center"> </el-table-column>
              <el-table-column  prop="userName" label="变量内容"   align="center"></el-table-column>
          </el-table>
