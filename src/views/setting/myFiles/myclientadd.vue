      ...
      <div class="mbottom">
        <div class="goods-fitter">
          <div class="search-wrapper1">
            ...
            <h4 class="title1">客户资料信息<span v-if="state==2">编辑</span></h4>-->
          </div>
        </div>
      </div>
      <div class="mbottom">
            ...
            <el-row>
              <el-col :span="5" v-if="state!=2">
                <el-form-item label="账户:" prop="sysuserAccount">
                  <el-input v-model="form.sysuserAccount" :disabled="state==2" placeholder="请填写账号"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="5" v-if="state!=2">
            ...
            <el-row>
              ...
              <el-col :span="5">
                <el-form-item label="行业小类:" prop="industrySubcategory">
                  <el-select v-model="form.industrySubcategory" placeholder="请选择行业小类">
                    <el-option
            ...
            <el-row>
              ...
              <el-col :span="5">
                <el-form-item label="注册电话:" prop="customerTel" >
                  <el-input v-model="form.customerTel" placeholder="请填写册电话"  type="number"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="5">
...
export default {
  ...
  methods: {
    ...
    async _getUserPage(){
      ...
      obj.current_page = 1
      obj.page_size = 0
      let data = await getUserPage(obj)
    ...
    cateBig(val) {
      ...
      let parentId = null;
      list.forEach(value => {
        if (value.dictionaryName == val) {
          parentId = value.dictionaryId;
        }
      });
      getindustrySubcategory(parentId).then(res => {
        this.industrySubcategory_options = res.data;
      });
    },
    //获取行业大类
    _getindustryCategory() {
      getindustryCategory().then(res => {
        this.industryCategory_options = res.data;
      });
    },
    //获取省
    _getprovince() {
