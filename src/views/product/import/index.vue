    ...
    <div class="mcard">
      <el-row class="operate mbottom">
          <el-col :span="21">
            ...
            <el-button type="primary" >导入第三方货号</el-button>
      ...
      <el-table :data="data"  border  style="width: 100%" stripe>
            <el-table-column  type="序号"  width="55" align="center"> </el-table-column>
            <el-table-column  prop="name" label="商品货号"   align="center"></el-table-column>
            <el-table-column  prop="name" label="第三方平台名称" align="center"></el-table-column>
            <el-table-column  prop="name" label="第三方平台商品编号" align="center"></el-table-column>
            <el-table-column  prop="name" label="第三方平台采购价" align="center"></el-table-column>
            <el-table-column  prop="name" label="第三方平台零售价" align="center"></el-table-column>
