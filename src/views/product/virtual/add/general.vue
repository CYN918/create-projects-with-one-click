            ...
            <el-row>
              <el-col :span="5">
                <el-form-item prop="productSize" label="商品尺寸：">
                  <el-input v-model="form.productSizelong" placeholder="长/cm" size='small' type="number"></el-input>
                  <el-input v-model="form.productSizewide" placeholder="宽/cm" size='small' type="number"></el-input>
                  <el-input v-model="form.productSizeheight" placeholder="高/cm" size='small' type="number"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="5">
              ...
              <el-col :span="5">
                <el-form-item prop="packSize" label="装箱尺寸：">
                  <el-input v-model="form.packSizelong" placeholder="长/cm" size='small' type="number"></el-input>
                  <el-input v-model="form.packSizewide" placeholder="宽/cm" size='small' type="number"></el-input>
                  <el-input v-model="form.packSizeheight" placeholder="高/cm" size='small' type="number"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="5">
                ...
                <el-table-column prop="volumeCarriage3" label="运费3" align="center" width="80">
                  <template slot-scope="scope">
                    <el-form-item :prop="'tableData.'+scope.$index+'.volumeCarriage3'">
                      <el-input v-model.trim="scope.row.volumeCarriage3" placeholder="请输入"></el-input>
                    </el-form-item>
                  </template>
                </el-table-column>
            ...
            <el-form-item prop="reference" label="参考报价：" class="reference">
              ...
              <el-table :data="form.domains" border>
                ...
                <el-table-column prop="ppt" label="京东链接" align="center">
                  <template slot-scope="scope">
                    <el-input v-model.trim="scope.row.jd_link" placeholder="请输入京东链接" @blur="jd_method"></el-input>
                  </template>
                </el-table-column>
...
export default {
  ...
  data() {
    ...
    var productSize = (rule,value,callback) => {
      if(this.form.productSizelong != '' &&　this.form.productSizewide != ''　&& this.form.productSizeheight != ''){
        callback()
      }else{
    ...
    var packSize = (rule,value,callback) => {
      if(this.form.packSizelong != '' &&　this.form.packSizewide != ''　&& this.form.packSizeheight != ''){
        callback()
      }else{
    ...
    return {
      ...
      rules: {
        ...
        packSize: [
          { required: true, validator:packSize, trigger: "blur" }
        ],
        grossWeight: [
