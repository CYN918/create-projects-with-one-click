  ...
  <div class="margin">
    ...
    <div class="mcard">
      <div class="mbottom">
        ...
        >批量操作</el-button>
        <el-button type="primary" size="small" @click="$router.push({  name: 'ProductvirtualAdd'}) " v-permit="'Add:goods'">添加商品</el-button>
      </div>
      <el-table
      v-loading="loading"
      ...
      >
        ...
        <el-table-column label="价格信息" align="center" width="150">
          <template slot-scope="scope">
            ...
            <div
              class="txt_left"
            >运费：{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice != 0?scope.row.skuInfo[scope.row.index].priceInfo.costPrice:scope.row.skuInfo[scope.row.index].priceInfo.costPrice == ''?'含运费':'含运费'}}</div>
            <div
              class="txt_left"
        ...
        <el-table-column label="操作" align="center" width="150" fixed="right">
          <template slot-scope="scope">
            ...
            <div class="line-div small_top" style="padding-bottom: 0">
              ...
              <div class="small-Idiv" @click="submitScenario(scope.row.goodsId)">
            ...
            <div class="line-div small_top" style>
              <div class="small-Idiv" @click="goodsDetail">
