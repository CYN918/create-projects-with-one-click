     ...
     <div class="margin">
      <div class="tabs-header">
        <ul class="clearfix">
            ...
            <li class ="link" @click="tabIndex0(1)"  :class="currentIndex0===1 ? 'active' : ''">已报价</li>
...
import Inquiried from './inquiried/index'
import Inquirys from './inquiry/index'
