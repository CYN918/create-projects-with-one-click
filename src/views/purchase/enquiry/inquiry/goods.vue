        ...
        <el-table-column label="商品信息" prop="name" align="center" width="200">
          <template slot-scope="scope">
            ...
            <div class="txt_left">
              ...
              <span style="margin-right:13px;">K</span>U：{{scope.row.goodsSkuId}}
            </div>
          </template>
        </el-table-column>
...
export default {
  ...
  props: ["goodsList","count","closeId","closeNo"],
  watch: {
