              ...
              <div class="mbottom">
                <div class="goods-fitter">
                  <div class="mcard" style="padding-bottom:0">
                    ...
                    class="el1" ref="elTables1" @selection-change="AhandleSelectionChange">
                      ...
                      <el-table-column label="不含税成本价" align="center" width="105">
                        <template slot-scope="scope">
                          <el-input size="small"  v-model="scope.row.notaxCostPrice"></el-input>
                        </template>
                      </el-table-column>
                      ...
                      >
                        <template slot-scope="scope">
                          <el-input size="small" v-model="scope.row.productRequire"></el-input>
                        </template>
                      </el-table-column>
                    </el-table>
              ...
              <div class="mbottom">
                <div class="goods-fitter">
                  <div class="mcard" style="padding-bottom:0">
                    ...
                    class="el2" ref="elTables2" @selection-change="BhandleSelectionChange">
                    <el-table-column type="selection" align="center"></el-table-column>
                      <el-table-column label="序号" type="index" align="center" width="50"></el-table-column>
                      <el-table-column
                        prop="commonContactName"
...
import {purchaseHistory,offerHistory,saveInquiry,deleteInquiryPrice} from '@/api/purchase/index'
