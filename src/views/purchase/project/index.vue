  ...
  <div class="margin">
          ...
          <div class="search-wrapper">
            ...
            <div class="search-base">
              <el-row>
                ...
                <el-col :span="1" class="btn_right">
                    <el-button  size="small">产品搜索</el-button>
                </el-col>
              </el-row>
              <el-row>
                  <el-col :span="8">
    ...
    <div class="mcard">
      ...
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        <el-table-column  prop="name"  label="订单信息" align="center"></el-table-column>
        <el-table-column  prop="name"  label="报价状态" align="center"></el-table-column>
        <el-table-column  prop="name"  label="指定的采购组" align="center"></el-table-column>
        ...
        <el-table-column  prop="name"  label="是否需要发票" align="center"></el-table-column>
        <el-table-column  prop="name"  label="销售代表" align="center"></el-table-column>
     ...
     <div class="mcard" style="margin-top:20px">
      ...
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        <el-table-column  prop="name"  label="报价状态(采购)" align="center"></el-table-column>
        ...
        <el-table-column  prop="name"  label="制作要求" align="center"></el-table-column>
        <el-table-column  prop="name"  label="交期" align="center"></el-table-column>
        ...
        <el-table-column  prop="name"  label="推荐供应商" align="center"></el-table-column>
        <el-table-column  prop="name"  label="采购成品价" align="center"></el-table-column>
