              ...
              <div class="goods-fitter">
                <div class="mcard" style="padding-bottom:0;">
                  <div class="goodsHeader">
                    ...
                    <span
                      class="serial"
                      style="display:inline-block;width:9.8%;text-align:center;"
                    >图样</span>
                    <span
                      class="serial"
                      style="display:inline-block;width:14.7%;text-align:center;"
                    >商品名称</span>
                    <span
                      class="serial"
                      style="display:inline-block;width:11.1%;text-align:center;"
                    >品牌</span>
                    <span
                      class="serial"
                      style="display:inline-block;width:11.2%;text-align:center;"
                    >型号</span>
                    <span
                      class="serial"
                      style="display:inline-block;width:11.2%;text-align:center;"
                    ...
                    <span
                      class="serial"
                      style="display:inline-block;width:11.7%;text-align:center;"
                    >规格尺寸</span>
                    <span
                      class="serial"
                      style="display:inline-block;width:12.1%;text-align:center;"
                    >数量</span>
                    <span
                      class="serial"
                      style="display:inline-block;width:14.1%;text-align:center;border-right:1px solid #EBEEF5"
                    >制作要求</span>
                  </div>
                  <div class="goodsContent">
                    ...
                    <div
                      class="content"
                      style="width:9.8%;text-align:center;height:120px;padding:10px 0"
                    >
            ...
            <div class="search-base">
              <div class="mbottom">
                <div class="goods-fitter">
                  <div class="mcard" style="padding-bottom:0">
                    <el-table
                      :data="goodsList.quotes"
                      border
                      style="width: 100%"
                      stripe
                      @selection-change="AhandleSelectionChange"
                    >
                      ...
                      >
                        <template slot-scope="scope">
                          <el-button
                            type="primary"
                            size="small"
                            @click="historyOffer(scope.row)"
                            v-permit="'pu:past_quote'"
                          >历史报价</el-button>
                          <div class="downButton">
                            <el-button
                              type="primary"
                              size="small"
                              @click="historySale(scope.row)"
                              v-permit="'pu:list_past_purchase'"
                            >历史采购</el-button>
                          </div>
                        </template>
                      </el-table-column>
                      ...
                      <el-table-column label="运费" align="center" width="105">
                        <template slot-scope="scope">
                      ...
                      <el-table-column label="操作" align="center" width="120" fixed="right">
                        <template slot-scope="scope">
                          <el-button
                            v-show="scope.row.quoteId"
                            type="primary"
                            size="small"
                            @click="pucharseGoods(scope.row)"
                            v-permit="'pu:save_order'"
                          >采购此商品</el-button>
                        </template>
                      </el-table-column>
                    </el-table>
                ...
                <div class="goods-fitter">
                  <div class="mcard" style="padding-bottom:0">
                    <el-table :data="offerList" border style="width: 100%" stripe>
                      ...
                      <el-table-column prop="commonContactDept" label="报价时间" align="center">
                        <template slot-scope="scope">{{scope.row.quoteTime}}</template>
                      </el-table-column>
                      ...
                      <el-table-column label="含税成本价" align="center">
                        <template slot-scope="scope">{{scope.row.taxCostPrice}}</template>
                      </el-table-column>
                    </el-table>
                  ...
                  <div class="mcard" style="padding-bottom:0">
                    <el-table :data="purchaseList" border style="width: 100%" stripe>
                      ...
                      <el-table-column prop="commonContactDept" label="采购数量" align="center">
                        <template slot-scope="scope">{{scope.row.purchasedQuantity}}</template>
                      </el-table-column>
                      <el-table-column label="含税成本价" align="center">
              ...
              <div class="goods-fitter">
                <div class="mcard" style="padding-bottom:0;">
                  <div class="goodsHeader">
                    ...
                    <span class="serial" style="padding:0 25px">数量</span>
                    <span class="serial" style="padding:0 10px">已采购数量</span>
                    <span class="serial" style="padding:0 44px;border-right:1px solid #EBEEF5">制作要求</span>
                  </div>
                  <div class="goodsContent">
                    <div class="content" style="text-align:center;line-height:120px;">1</div>
              ...
              >
                ...
                <el-table-column label="供应商" align="center" width="148">
                  <template slot-scope="scope">
                    <div
                      class="txt_left"
                    >名称：{{scope.row.skuList[scope.row.index]&&scope.row.skuList[scope.row.index].suppliersName}}</div>
                    <div
                      class="txt_left"
                    >性质：{{scope.row.skuList[scope.row.index]&&scope.row.skuList[scope.row.index].supplierNature}}</div>
                  </template>
                </el-table-column>
                      ...
                      <el-table-column label="商城价格" align="center" width="160">
                        <template slot-scope="scope">
                          <div style="height: 180px;overflow: auto;">
                            ...
                            <div
                              class="txt_left"
                            >运费：{{scope.row.skuList[scope.row.index].carriagePrice}}</div>
                            <div class="txt_left">对外ppt价格：{{scope.row.pptPrice}}</div>
                            <div class="txt_left">对外最低价格：{{scope.row.minimumPrice}}</div>
                            <div class="txt_left">对我司的特惠价：{{scope.row.preferentialPrice}}</div>
                          </div>
                  ...
                  <div class="goods-fitter">
                    <div class="mcard" style="padding-bottom:0;">
                      <div class="goodsHeader">
                        ...
                        <span
                          class="serial"
                          style="padding:0 44px;border-right:1px solid #EBEEF5"
                        >制作要求</span>
                      </div>
                      <div class="goodsContent">
                        <div class="content" style="text-align:center;line-height:120px;">1</div>
                        <div
                          class="content"
                          style="width:119px;height:120px;padding:10px 0 0 10px;"
                        >
                          <img class="goodsImg" :src="goodsList.goodsImgUrl" alt />
                        </div>
                        <div
      ...
      <div class="mail-fitter" style="padding:20px 0;background:#fff;">
        <div class="search-base">
          <div class="goods-fitter">
            <el-row>
              <div class="tip">
                <img class="tipImg1" src="@/common/images/icon/确定推送.png" alt />
                <span>你确定要采购此商品吗？</span>
              </div>
            </el-row>
          </div>
        </div>
...
export default {
      ...
      handler(newVal, oldVal) {
        if (newVal) {
          for (let i = 0; i < newVal.length; i++) {
            if (
              Number(newVal[i].purchaseQuantity) >= 0 &&
              Number(newVal[i].taxCostPrice) >= 0
            ) {
              newVal[i].totalPrice =
                Number(newVal[i].purchaseQuantity) *
                  Number(newVal[i].taxCostPrice) +
                Number(newVal[i].carriagePrice);
            }
            //计算不含税价
            if (
              Number(newVal[i].taxRate) >= 0 &&
              Number(newVal[i].taxCostPrice >= 0)
            ) {
              newVal[i].notaxCostPrice =
                Number(newVal[i].taxCostPrice) /
                (1 + Number(newVal[i].taxRate) / 100);
            }
          }
        }
      },
  ...
  methods: {
    ...
    //供应商报价保存
    editInquirys() {
      this.goodsList.spogdId = this.goodsList.gdId;
      saveQuote(this.goodsList).then(res => {
        if (res.code === 200) {
    ...
    addClick(row) {
      ...
      if (this.selectData.length >= 1) {
        ...
        for (let i = 0; i < this.selectData.length; i++) {
          if (
            this.selectData[i].skuId == copy.skuId &&
            this.selectData[i].goodsId == copy.goodsId
          ) {
            throttleTipPop(
              this,
              "error",
      ...
      for (let a = 0; a < this.selectData.length; a++) {
        ...
        arr[a].taxRate = arr[a].rows.taxRate;
      ...
      if (this.goodsList.similarQuotes.length >= 1) {
        ...
        for (let i = 0; i < this.goodsList.similarQuotes.length; i++) {
          for (let j = 0; j < this.selectData.length; j++) {
            if (
              this.goodsList.similarQuotes[i].skuId == this.selectData[j].skuId
            ) {
              throttleTipPop(
                this,
                "error",
    ...
    addClick1(row) {
      ...
      if (this.selectData1.length >= 1) {
        ...
        for (let i = 0; i < this.selectData1.length; i++) {
          if (
            this.selectData1[i].skuId == copy.skuId &&
            this.selectData1[i].goodsId == copy.goodsId
          ) {
            throttleTipPop(
              this,
              "error",
    ...
    pushInquirys() {
      createPurchase(this.quoteId).then(res => {
        if (res.code === 200) {
          throttleTipPop(this, "success", "采购商品成功", 2000);
          this.pushVisible = false;
          this.detailVisible = false;
          this.$emit("pushPurchase", this.detailVisible);
        }
      });
    },
    _offerHistory() {
