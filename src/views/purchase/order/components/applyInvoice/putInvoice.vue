  ...
  <div id="toInvioce">
    <el-dialog width="73%" :visible.sync="addVisible" :before-close="createClosing">
                  ...
                  <el-col :span="8">
                    <el-col>
                      <el-form-item label="采购单号：">
                        <el-col :span="19">{{pageData.purchaseOrderNo}}</el-col>
                      </el-form-item>
                    </el-col>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="对应核销客户名称：">
                      <el-col :span="19">{{pageData.customerName}}</el-col>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="销售单号：">
                      <el-col :span="19">{{pageData.saleOrderNo}}</el-col>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="发票抬头：" prop="invoiceRise">
                      <el-col :span="19">
                        <el-select
                          v-model="pageData.invoicePayable"
                          placeholder="请选择"
                          style="width:100%;"
                        >
                          <el-option
                  ...
                  <el-col :span="12">
                    <el-col>
                      <el-form-item label="发票编号：" prop="invoiceNumber">
                        <el-col :span="19">
                          <el-input v-model="pageData.invoiceNo"></el-input>
                        </el-col>
                      </el-form-item>
                    </el-col>
                  </el-col>
                  <el-col :span="12">
                    <el-col>
                      <el-form-item label="发票金额：" prop="invoiceNumber">
                        <el-col :span="19">
                          <el-input v-model="pageData.invoiceAmount"></el-input>
                        </el-col>
                      </el-form-item>
                    </el-col>
                  </el-col>
              ...
              <div class="goods-fitter" v-if="this.orderIndex===1">
                <div class="mcard" style="padding-bottom:0">
                  <el-table :data="pageData.goodsDetailList1" border style="width: 100%" stripe>
                    ...
                    <el-table-column prop="name" label="采购单号" align="center" width="120">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveRecord()" size="small">确 定</el-button>
      </span>
    </el-dialog>
    <!-- 上传预览 -->
...
import { saveInvoiceRecord } from "@/api/purchase/index";
...
export default {
  ...
  computed: {
    total1() {
      ...
      let _this = this;
      if (
        _this.pageData.goodsDetailList2 &&
        _this.pageData.goodsDetailList2.length > 0
      ) {
    ...
    "pageData.goodsDetailList2": {
      handler(newVal, oldVal) {
        for (let i = 0; i < newVal.length; i++) {
          if (
            parseFloat(newVal[i].goodsCount) >= 0 &&
            parseFloat(newVal[i].goodsPrice) >= 0
          ) {
            newVal[i].totalPrice =
              parseFloat(newVal[i].goodsCount) *
              parseFloat(newVal[i].goodsPrice);
          }
        }
      },
      deep: true
  ...
  methods: {
    ...
    saveRecord() {
      let obj = {};
      obj.invoiceId = this.pageData.invoiceId;
      obj.invoiceNo = this.pageData.invoiceNo;
      obj.fileInvoiceUrl = this.pageData.fileInvoiceUrl;
      obj.collectDate = this.pageData.collectDate;
      obj.remark = this.pageData.remark;
      obj.purchaseOrderId = this.purchaseOrderId;
      saveInvoiceRecord(obj).then(res => {
        if (res.code === 200) {
          throttleTipPop(this, "success", "保存收票信息成功", 2000);
          this.addVisible = false;
          this.$emit("savaRocord1", this.addVisible);
        }
      });
    },
    //鼠标划入
