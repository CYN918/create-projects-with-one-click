<template>
    <div>
        <!--  取消合同审批 -->
   <el-dialog width="75%" :visible.sync="removeVisible" :before-close="createClosing">
      <div class="mbottom">
      ...
      <div class="mcard0">
        <div class="mcard">
          ...
          <el-form ref="infoForm" :model="initData1" :rules="rules" label-width="140px"  size="small">
            <el-row>
              <el-col :span=8>
          ...
          <el-row>
              <el-col :span=8>
                <el-form-item label="取 消 人 ：">                       
                              <span>{{initData1.cancelUserName}}</span>                        
                </el-form-item>
              </el-col>
              <el-col :span=8>  
                <el-form-item label="部 门：" >                       
                                <span>{{initData1.cancelDepartmentName}}</span>                    
                </el-form-item> 
              </el-col>
              <el-col :span=8>  
                <el-form-item label="职位：" >                       
                                <span>{{initData1.cancelPosition}}</span>                    
                </el-form-item> 
              </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="12">
                  <el-form-item label="订单状态：" prop="cacelType">                       
                         <el-col :span="20">
                                  <el-input
                                v-model="form.cacelType" readonly>
                                  </el-input>  
                        </el-col>              
                </el-form-item> 
              </el-col>
           ...
           <el-row>
            <el-col :span="12">
                  <el-form-item label="已付供应商定金：" prop="depositStatus">                       
                          <el-col :span="20">
                                  <el-select
                                v-model="initData1.depositStatus"
                                style="width:100%">
                                <el-option
          ...
          <el-row>
            <el-col :span="23">
                <el-form-item label="取消说明：">
                    ...
                    :rows="3"
                    placeholder="请输入内容"
                     v-model="initData1.cancelReason" readonly>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="danger" @click="removeVisible=false" size="small">关 闭</el-button>
...
import {CancelContractApproval,getCancelContractPlan} from '@/api/purchase/index'
...
export default {
    ...
    props:['removeVisibles','scGoodsData','poGoodsData','cancelData1',"auditPushData","userData1",'showId'],
    watch:{
        removeVisibles(val){
            this.removeVisible = val;
        },
        scGoodsData(val){
    ...
    methods:{
        ...
        this.$confirm('您确认要关闭吗？')
                      ...
                      this.$emit("createCloseR", this.removeVisible);
                })
                .catch(_ => {});
        },
        createClosing() {
        ...
        this.$confirm('您确认要关闭吗？')
                        .then(_ => {
                      this.removeVisible = false;
                      this.$emit("createClosingR", this.removeVisible);
                })
                .catch(_ => {});
        },
        tabIndex0 (index) {
      ...
      handlePictureCardPreview() {
        this.dialogImageUrl = this.initData1.contractFile;
      ...
      //删除
       ...
       Audit(){
         ...
         getCancelContractPlan(this.contractId).then(res=>{
          if(res.code===200){ 
       ...
       cancelAudit(){
           ...
           CancelContractApproval(obj).then(res=>{
               if(res.code===200){
                    throttleTipPop(this, "success","提交取消订单审批成功！", 2000);
                    this.removeVisible = false;
                    this.$emit("romoveContract",this.removeVisible);
               }
           })
       }
