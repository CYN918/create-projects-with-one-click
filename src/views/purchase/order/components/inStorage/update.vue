<template>
  <div id="addPurchasing">
    <el-dialog width="60%" :visible.sync="updateVisible" :before-close="createClosing">
      <div class="mbottom">
        <div class="goods-fitter">
          <el-form label-width="100px" size="small">
            <div class="search-wrapper">
              <h4 class="title">上传物流信息</h4>
            </div>
          </el-form>
        </div>
      </div>
            ...
            <div class="search-wrapper">
              ...
              <div class="search-base">
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="更新日期：" prop="update">
                      <el-col :span="19">
                        <el-date-picker
                          v-model="storeData.updateTime"
                          type="date"
                          placeholder="选择日期"
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="发往仓库：" prop="toWarehouse" readonly>
                      <el-col :span="19">
                        <el-input v-model="storeData.warehouseName"></el-input>
                      </el-col>
                    </el-form-item>
                  </el-col>
                </el-row>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="updateLogistics" size="small">保存</el-button>
      </span>
    </el-dialog>
    <!-- 上传预览 -->
...
import { updateStorage } from "@/api/purchase/index";
...
export default {
  ...
  created() {},
  props: ["updateVisibles", "storageData", "logisticsList"],
  watch: {
    updateVisibles(val) {
  ...
  methods: {
    ...
    createClose() {
      this.$confirm("您确认要关闭吗？")
        .then(_ => {
          ...
          this.files = [];
          this.$emit("createCloseU", this.updateVisible);
        })
        .catch(_ => {});
    },
    createClosing() {
      this.$confirm("您确认要关闭吗？")
        .then(_ => {
          this.updateVisible = false;
          this.files = [];
          this.$emit("createClosingU", this.updateVisible);
        })
        .catch(_ => {});
    },
    //更新物流
    updateLogistics() {
      ...
      this.storeData.estimatedArrivalDate = this.storeData.updateTime;
      updateStorage(this.storeData).then(res => {
        if (res.code === 200) {
          throttleTipPop(this, "success", "更新物流成功！", 2000);
          this.updateVisible = false;
          this.$emit("updateStorage1", this.updateVisible);
        }
      });
    },
    handleProgress() {
