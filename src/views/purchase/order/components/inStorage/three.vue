    ...
    <div class="mcard" style="border:1px solid #d7e0f1">
      ...
      >
        ...
        <el-table-column label="预计到货日期" prop="name" align="center" width="110">
          <template slot-scope="scope">{{scope.row.estimatedArrivalDate}}</template>
        </el-table-column>
        <el-table-column label="物流单图片" prop="name" align="center" width="110">
          <template slot-scope="scope">
            <span v-if="scope.row.logisticsNoFileUrl" @click="preview(scope.row)" class="blue">查看</span>
            <span v-if="!scope.row.logisticsNoFileUrl">暂无物流单图片</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" fixed="right" width="130">
          <template slot-scope="scope">
            <div class="line-div">
              <div class="small-Idiv" @click="createOrder(scope.row)" v-permit="'storage:save'">
                <div class="i-div">
            ...
            <div class="line-div">
              <div class="small-Idiv" @click="update(scope.row)" v-permit="'storage:update'">
                <div class="i-div">
