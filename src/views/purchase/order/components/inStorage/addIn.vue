                  ...
                  <el-col :span="12">
                    <el-col>
                      <el-form-item label="入库单号：">
                        <el-col :span="19">
                          <span style="color:#C4C6CC">保存后自动生成</span>
                        </el-col>
                      </el-form-item>
                    </el-col>
                  </el-col>
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="入 库 人：" prop="storageMan">
                      <el-col :span="19">
                        <el-input
                          v-model="form.warehousingUserName"
                          v-if="userList.length<1"
                          readonly
                        ></el-input>
                        <el-select
                          v-model="form.warehousingUserId"
                          placeholder="请选择"
                          v-if="userList.length>=1"
                          style="width:100%"
                ...
                <div class="mbottom">
                  <div class="goods-fitter">
                    <div class="mcard" style="padding-bottom:0">
                      <el-table :data="storageData.details" border style="width: 100%" stripe>
...
export default {
  ...
  data() {
    return {
      ...
      dialogImageUrl: "",
      dialogVisible: false,
      dialogGoodsVisible: false, //选择入库人
      storeData: "",
      deletePath: "", //删除上传路径
      imgArr: [], //上传数组
      purchaseOrderId1: "",
  ...
  watch: {
    ...
    "ruleForm.organizeId": {
      handler(val) {
        this.userList = [];
        this.form.warehousingUserName = "";
        this.form.warehousingUserId = "";
        if (val) {
          let data = {};
          data.organizeId = val;
  ...
  methods: {
    ...
    createStorage() {
      this.storageData.storageDate = this.form.storageDate;
      this.storageData.warehouseId = this.form.warehouseId;
      this.storageData.logisticsCode = this.form.logisticsCode;
      this.storageData.logisticsNo = this.form.logisticsNo;
      this.storageData.logisticsTel = this.form.logisticsTel;
      this.storageData.logisticsNoFileUrl = this.form.imgUrl;
      this.storageData.logisticsRemark = this.form.logisticsRemark;
      this.storageData.warehousingUserName = this.form.warehousingUserName;
      this.storageData.warehousingUserId = this.form.warehousingUserId;
      saveStorage(this.storageData).then(res => {
        if (res.code === 200) {
          throttleTipPop(this, "success", "生成入库单成功！", 2000);
          this.addVisible = false;
    ...
    chooseWarehousingUser(data) {
      ...
      this.form.warehousingUserName = obj.sysuserName;
    },
    handleSizeChange() {},
    handleCurrentChange() {},
    handleChange() {}
