<template>
  <div id="purchaseAddContract">
    <el-dialog width="72%" :visible.sync="contractVisible" :before-close="createClosing">
      <!-- 选择签合同公司 -->
      <div class="mbottom">
                  ...
                  <div class="mcard" style="padding-bottom:0">
                    <el-table :data="proList.details" border style="width: 100%" stripe>
                      ...
                      <el-table-column prop="commonContactDept" label="数量" align="center">
                        <template slot-scope="scope">{{scope.row.purchaseQuantity}}</template>
                      </el-table-column>
                      ...
                      <el-table-column prop="commonContactDept" label="定制要求" align="center">
                        <template slot-scope="scope">{{scope.row.productRequire}}</template>
                      </el-table-column>
                      ...
                      <el-table-column prop="commonContactDept" label="交货日期" align="center">
                        <template slot-scope="scope">{{scope.row.distributionTime}}</template>
                      </el-table-column>
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item label="结算方式：" prop="settlementType">
                    <el-col :span="19">
                      <el-select
                        v-model="proList.settlementType"
                        placeholder="请选择"
                        style="width:100%"
                        @change="settlementVal"
                      >
                        <el-popover
                          placement="left"
                          title="分期付款"
               ...
               <el-row v-if="showIndex===1">
                <el-col :span="12">
                  <el-col>
                    <el-form-item label="预付款：">
                      <el-col :span="19">
                        <el-input v-model="proList.perpayments"></el-input>
                      </el-col>
                    </el-form-item>
                  </el-col>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="余款：">
                      <el-col :span="19">
                        <el-input v-model="proList.balance"></el-input>
                      </el-col>
                  </el-form-item>
                </el-col>
              </el-row>
...
export default {
  ...
  props: ["contractVisibles", "productList"],
  watch: {
  ...
  methods: {
    ...
    createClose() {
      this.$confirm("您确认要关闭吗？")
        .then(_ => {
          ...
          this.$emit("createCloseA", this.contractVisible);
          this.fileList = [];
        })
        .catch(_ => {});
    },
    createClosing() {
      this.$confirm("您确认要关闭吗？")
        .then(_ => {
          this.contractVisible = false;
          this.fileList = [];
          this.$emit("createClosingA", this.contractVisible);
        })
        .catch(_ => {});
    },
    _getGoods() {
    ...
    createSave() {
      ...
      if (
        ...
        !this.proList.aaddress ||
        !this.proList.acontact ||
        !this.proList.atel | !this.proList.bankOpeningName ||
        ...
        createPurchaseContract(this.proList).then(res => {
          if (res.code === 200) {
            if (!this.proList.contractId) {
              throttleTipPop(this, "success", "生成采购合同成功", 2000);
              this.contractVisible = false;
              this.$emit("saveContractA", this.contractVisible);
            } else {
    ...
    handleSuccess(file) {
      this.proList.details[this.upLoadIndex].fileDesignDraftUrl =
        file.data.domain + file.data.filePath;
      let obj = {};
      obj.designDraftUrl = this.proList.details[
        this.upLoadIndex
      ].fileDesignDraftUrl;
      obj.gdId = this.gdId;
      //调用上传设计稿接口
