<template>
    <div id="editPurchaseContract">
      <el-dialog width="72%" :visible.sync="editVisible" :before-close="createClosing">
        ...
        <div class="mbottom">
          <div class="goods-fitter">
             <el-form ref="infoForm" :model="detailData1" :rules="rules" label-width="150px" size="small">
              <div class="search-wrapper">
                <div class="mbottom">
                ...
                <div class="search-base">
                  ...
                  <el-row>
                    ...
                    <el-col :span="12">
                      <el-form-item label="乙方：" prop="bcompanyName">
                        <el-col :span="19">
                  ...
                  <el-row>
                    ...
                    <el-col :span="12">
                      <el-form-item label="联系人：" prop="bcontact">
                        <el-col :span="19">
                  ...
                  <el-row>
                    ...
                    <el-col :span="12">
                      <el-form-item label="联系电话：" prop="btel">
                        <el-col :span="19">
                  ...
                  <el-row>
                   ...
                   <el-row>
                    ...
                    <el-col :span="12">
                      <el-form-item label="地址："  prop="baddress">
                        <el-col :span="19">
                  ...
                  <div class="mbottom">
                    <div class="goods-fitter">
                      <div class="mcard" style="padding-bottom:0">
                         <el-table :data="detailData1.details" border style="width: 100%" stripe>
        ...
        <div class="goods-fitter">
          <el-form ref="infoForm" :model="detailData1" :rules="rules" label-width="120px" size="small">
            <div class="search-wrapper">
              <div class="mbottom">
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="结算方式：" prop="settlementType">
                      <el-col :span="19">
                        <el-select v-model="detailData1.settlementType" placeholder="请选择" style="width:100%">
                    ...
                    <el-col>
                      <el-form-item label="回票日期：" prop="ticketDate">
                        <el-col :span="19">
                          ...
                          v-model="detailData1.ticketDate"
                          style="width:100%;"
      ...
      <el-dialog width="50%" :visible.sync="accountVisible" :modal="true" :append-to-body="false">
        ...
        <!-- 新增地址 -->
      <el-dialog width="50%" :visible.sync="addressVisible" :modal="true" :append-to-body="false">
          <div class="mail-fitter">
            <div class="mbottom">
              <div class="goods-fitter">
                <el-form label-width="100px" size="small">
...
import {getOrderGoods,editContract,upLoadDesign} from "@/api/sale/index"
import {createPurchaseContract} from "@/api/purchase/index"
...
export default {
    data(){
        ...
        return{
            ...
            tableData: [],
                ...
                bcompanyName: [{ required: true, message: "此项为必选项", trigger: ["blur","change"] }],
                baddress: [
                { required: true, message: "此项为必选项", trigger: ["blur","change"] }
                ],
                bcontact: [
                ...
                bankAccount: [{ required: true, message: "此项为必选项", trigger: ["blur","change"] }],
                bankName: [{ required: true, message: "此项为必选项", trigger: ["blur","change"] }],
                bankOpeningName: [
                { required: true, message: "此项为必选项", trigger: ["blur","change"] }
                ],
                paymentAccount: [
    ...
    editVisibles(val) {
     ...
     computed: {
      ...
      let totals = 0
      let _this = this
      if(_this.detailData1.details&&_this.detailData1.details.length>0){
          for(var i = 0;i<_this.detailData1.details.length;i++){
            if(!isNaN(_this.detailData1.details[i].totalPrice)){
              totals+=parseFloat(_this.detailData1.details[i].totalPrice)
            }else{
              totals = 0
            }
      }
    ...
    //保存编辑
    editSave(){
        this.detailData1.payType = this.detailData1.settlementType;
        if(!this.detailData1.acompanyName||
        ...
        !this.detailData1.settlementType){
          ...
          createPurchaseContract(this.detailData1).then(res=>{
            if(res.code===200){
              if(!this.detailData1.contractId){
                  throttleTipPop(this, "success", "生成采购合同成功", 2000);
                  this.editVisible = false;
                  this.$emit('editContract',this.editVisible)
                }else{
                  throttleTipPop(this, "success", "修改采购合同成功", 2000);
                  this.editVisible = false;
                  this.$emit('editContract',this.editVisible)
                }
              } 
    ...
    addCompany(row){
        ...
        this.detailData1.acompanyName = this.companyData[0]&&this.companyData[0].sccCompanyName;
        this.detailData1.aaddress =this.companyData[0]&&this.companyData[0].sccAddress;
        this.detailData1.acontact = this.companyData[0]&&this.companyData[0].sccContacts;
        this.detailData1.atel= this.companyData[0]&&this.companyData[0].sccTelephone;
        this.detailData1.afax= this.companyData[0]&&this.companyData[0].sccFax;
        this.detailData1.aemail = this.companyData[0]&&this.companyData[0].sccEmail
    ...
    addAccount(row){
        ...
        this.detailData1.bankName = this.accountLists[0]&&this.accountLists[0].sccCompanyName;
        this.detailData1.bankOpeningName =  this.accountLists[0]&&this.accountLists[0].bankName;
        this.detailData1.taxNumber = this.accountLists[0]&&this.accountLists[0].sccTaxNum;
        this.detailData1.bankAccount = this.accountLists[0]&&this.accountLists[0].bankAccount;
    ...
    //上传商品设计稿
    handleSuccess(file){
        this.detailData1.details[this.upLoadIndex].fileDesignDraftUrl = file.data.domain + file.data.filePath;
         let obj = {};
        obj.designDraftUrl = this.detailData1.details[this.upLoadIndex].fileDesignDraftUrl;
        obj.gdId = this.gdId;
         //调用上传设计稿接口
