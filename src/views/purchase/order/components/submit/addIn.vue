                ...
                <div class="search-base">
                  ...
                  <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="入 库 人：" prop="storageMan">
                          <el-col :span="19">
                            <el-input v-model="storeData.warehousingUserName"  v-if="userList.length<1" readonly></el-input>
                            <el-select v-model="storeData.warehousingUserId" placeholder="请选择" v-if="userList.length>=1"
                            style="width:100%" @change="chooseWarehousingUser">
                                <el-option
                  ...
                  <el-row>
                    <el-col :span="12">
                        ...
                        <el-col :span="19">
                          <el-select v-model="storeData.warehouseId" placeholder="请选择"
                          style="width:100%">
                              <el-option
                    ...
                    <div class="search-base">
                        ...
                        <el-col :span="12">
                          <el-col>
                            <el-form-item label="物流公司：">
                              <el-col :span="19">
                                  <el-select v-model="storeData.logisticsCode" placeholder="请选择"
                                  style="width:100%">
                      ...
                      <el-row>
                          <el-form-item label="补充说明：" prop="footnote">
                            <el-col :span="22">
                                <el-input v-model="storeData.logisticsRemark"
                                type="textarea"
                    ...
                    <div class="goods-fitter">
                      <div class="mcard" style="padding-bottom:0">
                        <el-table :data="storeData.details" border style="width: 100%" stripe>
                          ...
                          <el-table-column prop="commonContactDept" label="单位" align="center" width="60">
                                     <template slot-scope="scope"> 
                                           {{scope.row.unit}} 
                                     </template>
                          </el-table-column>
                          ...
                          <el-table-column prop="commonContactDept" label="已入库数量" align="center" width="100">
                                      <template slot-scope="scope">
                                          {{scope.row.inputtedQuantity}}
                                      </template>
                          </el-table-column>
                          <el-table-column prop="commonContactDept" label="未入库数量" align="center" width="100">
                                      <template slot-scope="scope">
                                          {{scope.row.noInputQuantity}} 
                                      </template>
                          </el-table-column>
                          <el-table-column prop="commonContactDept" label="本次入库数量" align="center" width="110">
                                      <template slot-scope="scope">
...
export default {
   components: {
    ...
    props:["addVisibles","storageData",'purchaseOrderId','logisticsList','warehouseList',"sysuserName","ruleForm",'options1'],
    watch: {
        addVisibles(val) {
          this.addVisible = val; 
            },
            ...
            if(val.length>0){
              for(let i=0;i<val.length;i++){
                if(val[i].inputQuantity>val[i].noInputQuantity){
                      ...
                      throttleTipPop(this, "error","本次入库数量不能大于未入库数量！", 2000);
                }
              }
            }
          },
