                  ...
                  <el-col :span="6">
                    <el-form-item label="部门：">
                      <el-col :span="23">
                        <span
                          class="supplier"
                          :title="payData.applyOrganizeName"
                        >{{payData.applyOrganizeName}}</span>
                      </el-col>
                    </el-form-item>
                  </el-col>
                </el-row>
                    ...
                    <el-col>
                      <el-form-item label="供应商名称：">
                        <el-col :span="23">
                          <span
                            class="supplier"
                            :title="payData.supplierName"
                          >{{payData.supplierName}}</span>
                        </el-col>
                      </el-form-item>
                    </el-col>
                  </el-col>
                  ...
                  <el-col :span="6">
                    <el-col>
                      <el-form-item label="源单类型：">
                        <el-col :span="23">{{payData.mergeType | merge}}</el-col>
                      </el-form-item>
                    </el-col>
                  </el-col>
                  <el-col :span="6">
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="付款原因：" prop="storageMan">
                      ...
                      <input
                        class="other"
                        disabled
                        v-show="this.otherIndex===0"
                        v-model="payData.payOtherReason"
                      />
                      <input
                        class="other"
                        v-show="this.otherIndex===1"
                        v-model="payData.payOtherReason"
                      />
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    <el-form-item label="预付定金：" prop="storageMan" v-if="this.showIndex===1">
                      ...
                      ，即
                      <input class="handsel" v-model="payData.deposit" />
元
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    ...
                    <div class="mcard" style="padding-bottom:0">
                      ...
                      >
                        <el-table-column label="序号" type="index" align="center" width="50">
                          <template
                            slot-scope="scope"
                          >{{scope.$index + (currPage - 1) * pageSize + 1}}</template>
                        </el-table-column>
                        <el-table-column
                          prop="customerType"
                          label="采购订单号"
                        ...
                        <el-table-column prop="commonContactName" label="发货订单号" align="center">
                          <template slot-scope="scope">{{scope.row.spoNo}}</template>
                        </el-table-column>
                        <el-table-column
                          ...
                          width="100"
                        >
                          <template slot-scope="scope">{{scope.row.purchaseUserName}}</template>
                        </el-table-column>
                        ...
                        <el-table-column
                          ...
                          width="100"
                        >
                          <template slot-scope="scope">{{scope.row.surplusQuantity}}</template>
                        </el-table-column>
                        ...
                        <el-table-column prop="totalPrice" label="含税总金额" align="center" width="100">
                          <template
                            slot-scope="scope"
                          >{{Math.floor(scope.row.totalPrice * 100) / 100}}</template>
                        </el-table-column>
                      </el-table>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editPayment()" size="small">保存</el-button>
      </span>
    </el-dialog>
...
import { saveStorage, editPurchasePayment } from "@/api/purchase/index";
...
export default {
  ...
  computed: {
    ...
    pageList() {
      ...
      if (this.payData.details) {
        return this.payData.details.slice(
          (currPage - 1) * pageSize,
          currPage * pageSize
        );
      }
  ...
  methods: {
    ...
    editPayment() {
      ...
      editPurchasePayment(this.payData).then(res => {
        if (res.code === 200) {
          throttleTipPop(this, "success", "更新付款申请成功！", 2000);
          this.editVisible = false;
          this.showIndex = 0;
          this.otherIndex = 0;
          this.$emit("editAppPay1", this.editVisible);
        }
      });
    },
    depoit(val) {
