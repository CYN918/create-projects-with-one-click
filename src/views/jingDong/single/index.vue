						...
						<div class="goods-fitter">
								<el-form label-width="260px" size="small">
										<div class="search-wrapper">
												...
												<div class="introduce">3、商品ID是京东商品链接里https://item.jd.com/11320871935.htm的一串数字</div>
										</div>
								</el-form>
						</div>
				</div>
								...
								<el-form ref="form" :model="form" label-width="260px" size="small">
										<div class="search-wrapper">
												...
												<el-form-item label="批量商品ID:">
														<el-input type="textarea" :rows="4" v-model="form.goods" style='width:600px'
...
<script>
    import {dataPost, getTreecatagory, getType} from '@/api/product/index'
    ...
    export default {
        ...
        methods: {
            ...
            postData() {
                ...
                //12313↵↵123↵2354
                var demo = this.form.goods.replace(/(\n){1,}/g, ",");
