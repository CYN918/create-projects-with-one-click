      ...
      <div class="mbottom">
        <div class="goods-fitter">
          <div class="search-wrapper">
            <h4 class="title">主题信息</h4>
            <br />
            <el-form-item label="主题类型：" prop="topicType">
              <el-select v-model="data.topicType" placeholder="请选择" style="width:600px">
                <el-option
            ...
            <!-- <el-form-item label="等级分类：" prop="categoryId">
              <el-select v-model="data.categoryId" placeholder="请选择" style="width:600px">
                <el-option
