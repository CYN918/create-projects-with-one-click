								...
								<div class="goods-fitter">
										<div class="search-wrapper">
												...
												<el-row :gutter="10">
														<el-col :span="8">
																<el-form-item label="主题名称：" prop="topicName">
																		<el-input placeholder="主题名称：" v-model="data.topicName"></el-input>
																</el-form-item>
														</el-col>
														<el-col :span="8">
												...
												<el-row :gutter="10">
														...
														<el-col :span="8">
																<el-form-item label="礼册数量: ">
																		<el-input v-model="input" placeholder="请输入礼册数量" size="small"></el-input>
																</el-form-item>
														</el-col>
												</el-row>
												<el-row :gutter="10">
														<el-col :span="8">
																<el-form-item label="礼册档位: ">
																		<el-input v-model="input" placeholder="请输入礼册档位"></el-input>
																</el-form-item>
														</el-col>
														<el-col :span="8">
																<el-form-item label="结算价格: ">
																		<span style="color:#f95957">¥10000</span>
																</el-form-item>
														</el-col>
												</el-row>
												<el-row :gutter="10">
												...
												<el-row :gutter="10" style="display: flex;justify-content: center">
														<div style="width: 1180px;border: 1px solid #eaeef7;padding: 20px 10px">
																<el-col :span="6" v-for="(o, index) in 8" :key="o" style="width: 24%;margin-right: 10px">
