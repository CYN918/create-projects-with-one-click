            ...
            <div class="search-base">
              <el-row>
                ...
                <el-col :span="1" class="btn_right">
                  <el-button type="primary" size="small" @click='reqActivityList(true)'>查询</el-button>
                </el-col>
              </el-row>
            </div>
          </div>
...
<script>
import { reqActivityList, topicdelete } from "@/api/giftvolume/index";
...
export default {
  ...
  methods: {
    ...
    async reqActivityList() {
      const res = await reqActivityList(this.form);
      console.log(res)
      if (res.code === 200) {
