<template>
  <div id="awardApplication">
    <div class="margin0">
      <div class="mbottom">
        <div class="goods-fitter">
          <el-form label-width="100px" size="small">
            <div class="search-wrapper">
              <h4 class="title">奖励申请</h4>
              <div class="search-base">
                <el-row>
                  ...
                  <el-col :span="5">
                    <el-form-item label="奖励人：">
                      <el-col :span="22">
                        <el-input v-model="form.price_min" placeholder="请输入奖励人"></el-input>
                      </el-col>
                    </el-form-item>
                  </el-col>
                  <el-col :span="5">
      ...
      <div class="mcard" style="border: 1px solid #d7e0f1;">
        <el-row class="operate mbottom">
          <el-col :span="22">
            <el-button type="primary" size="small" class="btn" @click="addAwardApplication">
              <img class="showImg" src="@/common/images/icon/新增凭证.png" alt />新增
            </el-button>
            <el-button type="primary" size="small" class="btn"  @click="editAwardApplication">
              <img class="showImg" src="@/common/images/icon/行政编辑.png" alt />编辑
            </el-button>
            <el-button type="primary" size="small" class="btn"  @click="detailAwardApplication">
              <img class="showImg" src="@/common/images/icon/行政查看.png" alt />查看
            </el-button>
            <el-button type="primary" size="small" class="btn"  @click="deleteAwardApplication">
        ...
        <el-table :data="tableData" border @selection-change="handleSelectionChange" show-summary>
          ...
          <el-table-column label="奖励人" prop="name" align="center" width="65"></el-table-column>
          <el-table-column label="奖励事由" prop="name" align="center" width="150"></el-table-column>
          <el-table-column label="奖励方式（非金额" prop="name" align="center" width="100"></el-table-column>
          <el-table-column label="奖励方式（金额）" prop="name" align="center" width="100"></el-table-column>
          ...
          <el-table-column label="操作" align="center" fixed="right" width="130">
            <template slot-scope="scope">
              <div class="line-div">
                  <div class="small-Idiv" @click="auditAwardApplication(scope.row)">
                  <div class="i-div">
    ...
    <Add
      ...
      @addAwardApplication1="addAwardApplication2"
    ></Add>
    <!-- 编辑奖励申请 -->
    <Edit
      ...
      @editAwardApplication1="editAwardApplication2"
    ></Edit>
    <!-- 查看奖励申请 -->
    <Detail
      ...
      @detailAwardApplication1="detailAwardApplication2"
    ></Detail>
    <!-- 查看奖励申请 -->
    <Audit
      ...
      @auditAwardApplication1="auditAwardApplication2"
    ></Audit>
    <!-- 删除奖励申请 -->
    <el-dialog :visible.sync="deleteVisible" width="20%" title="提示" style="top:20%">
      <div class="mail-fitter" style="padding:20px 0;background:#fff;">
...
export default {
  ...
  data() {
    return {
      addVisibles: false, //新增奖励申请
      editVisibles: false, //修改奖励申请
      detailVisibles: false, //查看奖励申请
      deleteVisible: false, //删除奖励申请
      auditVisibles:false,//审批奖励申请
      form: {
        current_page: 1,
        page_size: 10,
        total_count: 0
