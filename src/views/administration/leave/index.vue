  ...
  <div class="margin">
    ...
    <div class="mcard">
      ...
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        ...
        <el-table-column  prop="name"  label="请假日期" align="center"></el-table-column>
        <el-table-column  prop="name"  label="请假类别" align="center"></el-table-column>
        <el-table-column  prop="name"  label="请假事由" align="center"></el-table-column>
        <el-table-column  prop="name"  label="请假时间" align="center" ></el-table-column>
