    ...
    <div class="mcard">
      <el-row class="operate mbottom">
        ...
        <el-table   :data="tableData"  border style="width: 100%" stripe>
            ...
            <el-table-column  prop="name"  label="应发金额" align="center" ></el-table-column>
            <el-table-column  prop="name"  label="实发金额" align="center"></el-table-column>
            <el-table-column  prop="name"  label="未发金额" align="center"></el-table-column>
