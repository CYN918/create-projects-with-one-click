    ...
    <div class="mcard">
      <el-row class="operate mbottom">
        ...
        <el-table   :data="tableData"  border style="width: 100%" stripe >
            ...
            <el-table-column  prop="name"  label="年份" align="center"></el-table-column>
            ...
            <el-table-column  prop="name"  label="工资总额" align="center"></el-table-column>
            <el-table-column  prop="name"  label="月数" align="center"></el-table-column>
            <el-table-column  prop="name"  label="月均工资" align="center"></el-table-column>
