          ...
          <div class="search-wrapper" :content="content">
            ...
            <br />
             <el-form-item label="账户类型编号：">
              <el-input v-model="form.accountCode" style='width:300px' placeholder='请输入账号类型编号'></el-input>
             </el-form-item>

             <el-form-item label="账户类型名称：" class="is-required">
               <el-input v-model="form.accountName" style='width:300px' placeholder='请输入账号类型名称'></el-input>
             </el-form-item>
             <el-form-item label="账户类型：">
                  <el-radio v-model="form.accountType" label="0">现金账户</el-radio>
                  <el-radio v-model="form.accountType" label="1">授信账户</el-radio>
             </el-form-item>
