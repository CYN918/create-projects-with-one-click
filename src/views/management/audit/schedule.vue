<template>
    <div>
        ...
        >
            <div class="div_big">
                <div class="big_div" v-for="(item,index) in progressdata" :key="index">
                    <div class="big_ball">
                    ...
                    <div class="bor_left">
                        ...
                        <div>
                            ...
                            <span>
                <el-button type="primary" size="mini" v-if="index == num" style="position: absolute;margin-left: 15px;" @click="urgent(item)">加急处理</el-button>
              </span>
                        </div>
...
<script>
    import { findafterlog , urgeresolve } from '@/api/order'
    export default {
        props: {
            dialog:{
                type:Boolean
        ...
        methods: {
            async urgent(val){
                const data = await urgeresolve(val)
                if(data.code == 200){
                    this.$message({
