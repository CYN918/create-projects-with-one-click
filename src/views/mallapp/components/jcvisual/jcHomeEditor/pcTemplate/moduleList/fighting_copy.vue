<template>
    ...
    <div v-if="newArr.componentStatus==0">
        <div class="fightingContainer" v-if="isshow">
            <div class="groupBuy">
                <div  @mouseenter="isShowBtn=true"  @mouseleave="isShowBtn=false">
                    ...
                    <div class="newActivity">
                        ...
                        <div class="newActivityRight groupBuyRight" v-if="activityHomepageGoodsReturns&&activityHomepageGoodsReturns.length>0">
                            <div class="phoneEnterprise" v-for="(item,index) in activityHomepageGoodsReturns" :key="index">
                                <div class="text">
                                    ...
                                    <p>
                                        <a class="gotoGroup" style="color:white">
                                            去开团
                                        </a>
                                    </p>
                                </div>
