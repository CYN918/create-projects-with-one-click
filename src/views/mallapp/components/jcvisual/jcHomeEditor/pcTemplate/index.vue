<template>
		<div class="wrap">
				...
				<!-- <div class="center"> -->
				<draggable @update="datadragEnd" v-model="newArr" group="people" scroll="true" @scrollFn="handleScroll"
...
<script>
    ...
    import {getHomeDetails2, updateList} from '@/api/mallapp/homeEditor'
