        ...
        <el-form-item label="" label-width="180px">
            <el-dropdown  @command="handleCommand">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="500">上架</el-dropdown-item>
                <el-dropdown-item command="501">下架</el-dropdown-item>
                <el-dropdown-item command="503">信息变更</el-dropdown-item>
                <el-dropdown-item command="504">删除</el-dropdown-item>
                <el-dropdown-item command="506">移入回收站</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </el-form-item>
          <el-form-item label="商品审核：" prop="name">
            <el-radio-group v-model="ruleForm.enable">
              <el-radio label="0">需要审核</el-radio>
              <el-radio label="1">不需要审核</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="审核对象类型：" prop="name">商品 - {{text}}</el-form-item>
          ...
          <div
            ...
            :key="index"
          >
          <el-form-item v-if="index ===  0"  label="管理员审核权限：" label-width="248px">
                      <el-radio-group v-model="item.permission" @change="select(item, 'permission')">
                      ...
                      <span class="span_red" v-if="item.showradio">请选择审核权限</span>
                  </el-form-item>
            <el-form-item style="width: 300px;"  v-if="index !==  0"  label="部门：" :prop="'auditRoleList.'+ index +'.organizeId'" :rules="{ required: true, message: '请选择部门', trigger: 'change' }">
              <treeselect
                      style="width:218px"
                      :options='options'
                      search-nested
            ...
            <el-form-item label="审核人："   v-if="index !==  0">
              <el-select v-model="item.userId" clearable  :prop="'auditRoleList.'+ index +'.userId'"  :rules="{ required: true, message: '请选择审核人', trigger: 'change' }">
                <el-option
...
export default {
  ...
  methods: {
    ...
    _getfindbytype() {
      let $this = this;
      // 获取审核信息
      getfindbytype(this.numindex).then(res => {
