...
import  {AuditType} from '@/api/systemsettings/index.js'
...
export default {
  ...
  methods: {
    ...
    _getfindbytype() {
      let $this = this;
      // 获取审核信息
      getfindbytype(AuditType.GOODS_BRAND_OPENING).then(res => {
