...
export default {
  ...
  methods: {
    ...
    _getfindbytype() {
      let $this = this;
      // 获取审核信息
      getfindbytype(AuditType.GOODS_PUSH_AGENCY).then(res => {
