<template>
  <div class>
    <div class="mcard">
      <div class="title">企业用户注册审核配置</div>
      <div>
        <el-form
          :model="ruleForm"
          :rules="rules"
        ...
        >
          ...
          <el-form-item label="审核对象类型：" prop="name">企业用户</el-form-item>
        ...
        <div class="btn_div">
          <el-button type="danger" size="small" @click="resert" v-permit="'enterprise:reset'">重 置</el-button>
