  ...
  <div class>
    <div class="mcard">
      ...
      <div>
        ...
        <div class="btn_div">
          <el-button type="danger" size="small" @click="resert" v-permit="'Inorder:reset'">重 置</el-button>
          <el-button type="primary" size="small" @click="submit" v-if="isShow" v-permit="'Inorder:save'">确 定</el-button>
          <el-button type="primary" size="small" @click="saveChange" v-else v-permit="'Inorder:save'">保 存 修 改</el-button>
        </div>
      </div>
    </div>
  </div>
...
<script>
import { getfindbytype , ediotfindbytype, configuration,updatefindbytype,saveSetting} from "@/api/systemsettings/index";
