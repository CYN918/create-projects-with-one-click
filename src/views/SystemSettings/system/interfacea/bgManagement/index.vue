<template>
  <div class="margin interfacea">
    <div class="mcard" style="overflow: hidden;">
      <div class="title">管理后台界面配置</div>
      <div class="">
         <div>
              <el-button type="primary" size="small">管理后台设置</el-button>
              <span class="imgT" @click="backstage">
               <img src="../../../../../common/images/icon/收起.png" alt />&nbsp;&nbsp;<span>{{backstageTit}}</span>
             </span>
         </div>
         <p class="border_b"></p>
          <el-collapse-transition>
            <div  v-show="backstageShow">
            <el-form
              :model="ruleForm"
              :rules="rules"
              ref="ruleForm"
            ...
            <div v-for="(item,index) in dataArr" :key="index">
              <el-form-item v-if="index<=3" :label="item.settingName+'：'" prop="name">
        ...
        <p class="bg_manger"  v-show="backstageShow"></p>
      </div>
    
        <div class="col_last">
         <div>
              <el-button type="primary" size="small">管理后台底部导航栏设置</el-button>
              <span class="imgT" @click="backLink">
               <img src="../../../../../common/images/icon/收起.png" alt />&nbsp;&nbsp;<span>{{backTit}}</span>
             </span>
         </div>
         <p class="border_b" v-show="backLinkShow"></p>
          <el-collapse-transition>
            <div v-show="backLinkShow">
              <el-form ref="form"  label-width="80px" size="small">
                  <div   v-for="(item,index) in form.column"
                  :key="index">
                      <el-form-item label="栏目名称: " style="display: inline-block;">
                        <el-input v-model="item.columnName" placeholder="请输入"></el-input>
                      </el-form-item>
                      <el-form-item label="栏目链接: " style="display: inline-block;">
                        <el-input v-model="item.columnlink" placeholder="请输入"></el-input>
                      </el-form-item>
                      <span class="add" v-if="index == form.column.length-1"  @click="addcolumn">
                        <i class="iconfont icon-add"></i>
                        <span class="role1">增加</span>
                      </span>
                      <span class="add"  @click="deletecolumn(index)">
         ...
         <p class="border_b" v-if="form.copyRight.length>=1"></p>
          <div v-show="backLinkShow">
           <el-form ref="form"  label-width="80px" size="small">
              <div v-for="(item,index) in form.copyRight"
               :key="index">
                  <el-form-item label="版权信息: " style="display:inline-block">
                    <el-input v-model="item.copyRightInfo" placeholder="请输入"></el-input>
                  </el-form-item>
                  <span class="add"  @click="deleteInfo(index)">
                    <i class="iconfont icon-del"></i>
                    <span class="role1">删除</span>
                  </span>
              </div>
