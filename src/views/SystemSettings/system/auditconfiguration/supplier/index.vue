        ...
        >
          ...
          >
            <div style="display: flex">
              <el-form-item v-if="index ===  0"  label="管理员(采销员)审核权限：" label-width="220px">
                ...
                <div style="display: inline-block;margin-left: 20px;">
                  <span class="" v-if="index == ruleForm.auditRoleList.length-1" @click="addRole">
                    <i class="iconfont icon-add"></i>
                    <span class="role1">增加</span>
                  </span>
                        <span class="" v-if="index >= 1" @click="deleteRole(index)">
              ...
              <el-form-item  v-if="index !==  0"   style="width: 300px;" label="部门：" :prop="'auditRoleList.'+ index +'.organizeId'" :rules="{ required: true, message: '请选择部门', trigger: 'change' }">
                <treeselect
                        style="width:218px"
                        :options='options'
                        search-nested
              ...
              <el-form-item  v-if="index !==  0"   label="审核人：">
            ...
            <div class="btm_div"  v-if="index !==  0">
              <el-form-item
                label="审核权限："
...
<script>
  import {ediotfindbytype, getChildNodes, getfindbytype} from "@/api/systemsettings/index";
  import {throttleTipPop} from "@/utils/throttle";
  import Treeselect from '@riophae/vue-treeselect'
  import {getAllOrganizational, getrootnode} from "@/api/permissions/index";
  ...
  export default {
    ...
    methods: {
      ...
      this.showUserList(
        { organizeId: def },
        this.ruleForm.auditRoleList.length - 1
      );
    },
    _getfindbytype() {
      let $this = this;
      // 获取审核信息
      getfindbytype(1).then(res => {
