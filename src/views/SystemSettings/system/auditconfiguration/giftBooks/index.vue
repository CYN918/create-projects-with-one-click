          ...
          >
            <div style="display:flex">
              ...
              <el-form-item
                style="width: 300px;"
                label="部门："
                :prop="'auditRoleList.'+ index +'.organizeId'"
              ...
              <el-form-item label="审核人：">
                <el-select
                  v-model="item.userId"
                  :prop="'auditRoleList.'+ index +'.userId'"
