            ...
            <div class="dele_div">
              ...
              >
                ...
                />
                  ...
                  <el-form-item style="width: 300px;" label="部门：">
                    <treeselect
                      style="width:218px"
                      :options="options"
                      search-nested
                    ...
                    />
                    <span class="span_red" v-if="val.showOrgan">请选择部门</span>
                  </el-form-item>
                  <el-form-item label="审核人：">
                    <el-select v-model="val.userId" @change="select(val)" clearable >
                      <el-option
                ...
                <div class="btm_div">
                <el-form-item label="审核权限："   style="display: inline-block;" >
                  <el-radio-group v-model="val.permission" @change="select('',val)">
...
<script>
import { findbyaudittype, erpauditsetting } from "@/api/systemsettings/index";
import { throttleTipPop } from "@/utils/throttle";
import { getChildNodes, ErpAuditType } from "@/api/systemsettings/index";
...
export default {
  ...
  methods: {
    ...
    //查询数据
    async _findbyaudittype() {
      let $this = this;
      let { data } = await findbyaudittype(ErpAuditType.SALE_ORDER_CONTRACT);
    ...
    async submit() {
      ...
      let data = await erpauditsetting(obj);
      if (data.code == 200) {
