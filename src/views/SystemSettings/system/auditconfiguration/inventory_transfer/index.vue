  ...
  export default {
    ...
    async getrootnode() {
      ...
      _getfindbytype() {
        let $this = this;
        // 获取审核信息
        getfindbytype(AuditType.INVENTORY_TRANSFER).then(res => {
