<template>
  <div class>
    <div class="mcard">
      <div class="title">采购付款申请审核配置</div>
      <div>
        <el-form
                :model="ruleForm"
                :rules="rules"
  ...
  export default {
    ...
    async getrootnode() {
      ...
      _getfindbytype() {
        let $this = this;
        // 获取审核信息
        getfindbytype(AuditType.PURCHASE_PAYMENT_APPLY).then(res => {
