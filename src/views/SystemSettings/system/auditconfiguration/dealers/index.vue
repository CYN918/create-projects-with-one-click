        ...
        >
          ...
          >
            <div style="display: flex">
              <el-form-item v-if="index ===  0"  label="管理员(销售员)审核权限：" label-width="220px">
