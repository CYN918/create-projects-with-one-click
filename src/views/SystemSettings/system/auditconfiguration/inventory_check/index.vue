  ...
  export default {
    ...
    data() {
      return {
        ...
        ruleForm: {
          enable: "",
          auditMode: "",
          auditRoleList: [{ roleId: "", userId:"", permission: "" }],
          id: ""
        },
        rules: {},
    ...
    async getrootnode() {
      ...
      _getfindbytype() {
        let $this = this;
        // 获取审核信息
        getfindbytype(AuditType.INVENTORY_CHECK).then(res => {
