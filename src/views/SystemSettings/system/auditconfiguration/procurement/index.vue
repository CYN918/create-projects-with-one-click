            ...
            <div class="dele_div">
              ...
              >
                <div style="display:flex">
                  ...
                  <el-form-item style="width: 300px;" label="部门：" @change="select(val, 'organize')">
                    <treeselect
                      style="width:218px"
                      :options="options"
                      search-nested
...
export default {
  ...
  methods: {
    ...
    async _findbyaudittype() {
      let $this = this;
      let { data } = await findbyaudittype(
        ErpAuditType.PURCHASE_CONTRACT_APPLY
      );
