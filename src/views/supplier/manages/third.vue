  ...
  <div class="margin">
                    ...
                    <el-form-item label="经销商：">
                        <el-col :span="23">
                            <el-select
                                ...
                                placeholder="选择经销商"
                            >
                                <el-option label="经销商一" value="1"></el-option>
                                <el-option label="经销商二" value="2"></el-option>
                                <el-option label="经销商三" value="3"></el-option>
                            </el-select>
                        </el-col>
                    </el-form-item>
                  </el-col>
    ...
    <div class="mcard">
      ...
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        ...
        <el-table-column  prop="name"  label="供应商账号" align="center"></el-table-column>
        ...
        <el-table-column  prop="name"  label="上传商品数量" align="center"></el-table-column>
        <el-table-column  prop="name"  label="已上架商品数量" align="center" ></el-table-column>
        <el-table-column  prop="name"  label="待审核商品数量" align="center"></el-table-column>
        <el-table-column  prop="name"  label="停产商品数量" align="center" ></el-table-column>
      </el-table>
