                        ...
                        <div class="search-base">
                            <el-row>
                                ...
                                <el-col :span="5">
                                    <el-col>
                                        <el-form-item label="关键词：">
                                            <el-col :span="23">
                                                <el-input v-model="form1.supplierName"
                                                          placeholder="请输入供应商名称/联系人等"></el-input>
                                            </el-col>
                                        </el-form-item>
                                    </el-col>
                                </el-col>
                                ...
                                <el-col :span="1" class="btn_right">
                                    <el-button type="primary" size="small" @click="_getSupplierarchives(true)">查询
                                    </el-button>
                                </el-col>
                            </el-row>
                        </div>
            ...
            <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange" stripe>
                ...
                <el-table-column prop="supplierName" label="供应商信息" align="center" width="200">
                    <template slot-scope="scope">
                        ...
                        <el-button type="primary" size="small" @click="checkgoods(scope.row)" style="margin-top:10px">
                            查看商品
                        </el-button>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="营业执照" align="center" width="140">
                    <template slot-scope="scope">
                        ...
                        <div>
                            <el-button type="primary" size="small" @click="open(scope.row.businessLicense)">点击查看大图
                            </el-button>
                        </div>
                    </template>
                </el-table-column>
                    ...
                    <template slot-scope="scope">
                        ...
                        <div>
                            <el-button
                                    type="primary"
                                    size="small"
                                    @click="open(scope.row.taxpayerQualification)"
                            >点击查看大图
                            </el-button>
                        </div>
                    </template>
                ...
                <el-table-column prop="name" label="品牌授权书" align="center" width="140">
                    <template slot-scope="scope">
                        ...
                        <div>
                            <el-button type="primary" size="small" @click="open(scope.row.brandAuthUrl)">点击查看大图
                            </el-button>
                        </div>
                    </template>
                </el-table-column>
                <el-table-column prop="name" label="授权链" align="center" width="140">
                    <template slot-scope="scope">
                        <img :src="chain(scope.row)[0]" alt class="img_size"/>
                        <div>
                            <el-button
                                    type="primary"
                                    size="small"
                                    @click="open(chain(scope.row))"
                            >点击查看大图
                            </el-button>
                        </div>
                    </template>
                ...
                <el-table-column label="操作" align="center" fixed="right" width="170">
                    <template slot-scope="scope">
                        ...
                        <div class="line-div small_top">
                            <div class="small-Idiv" style="margin-left: -3px;"
                                 @click="detail(scope.row.auditId,scope.row.supplierId,scope.row.auditStatus,1)">
                                <div class="i-div">
    ...
    export default {
        ...
        methods: {
            ...
            detail(auditId, supplierId, auditStatus, state) {
                console.log(auditId, supplierId, auditStatus, state)
