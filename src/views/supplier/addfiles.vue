              ...
              <div class="search-base">
                ...
                <el-row>
                  <el-col :span="22">
                    ...
                    <el-col :span="6">
                      <el-form-item label="采销员：" prop="adminId">
                        <el-select
                          v-model="personalForm.adminId"
                          placeholder="请选择采销员"
                          style="max-width:200px"
                        >
                          <el-option
                    ...
                    <el-col :span="10"  class="multiselect">
                      <el-form-item label="入驻品类：" prop="supplier_name" ref="categorys">
                        <treeselect
                          :multiple="true"
                          :flat="true"
                          :limit="3"
                          ...
                          placeholder="请选择商品分类"
                          :clearable="true"
                          @input="$refs.categorys.clearValidate()"
                        />
                      </el-form-item>
                    </el-col>
                  </el-col>
...
export default {
  data() {
    ...
    var nextsure = (rule ,value , callback) => {
      callback();
    }
    return {
      pickerOptions0: {
      ...
      personalRules: {
        returnaddress:[
          { required: true, validator: nextsure, trigger: "blur" }
        ],
        supplierName: [
        ...
        supplier_name: [
          { type:Array,required: true, message: "请选择入驻品类", trigger: "blur" }
        ], //入驻品类
  ...
  created() {
    ...
    if (this.$route.query.id) {
      ...
      supplierApplyPostByid(this.supplierId).then(res => {
        ...
        if(res.data.extend.licenseTimeStart && res.data.extend.licenseTimeEnd){
        ...
        if(res.data.extend.authorizationTimeStart && res.data.extend.authorizationTimeEnd){
        ...
        if(res.data.extend.trademarkTimeStart && res.data.extend.trademarkTimeEnd){
        ...
        if(res.data.extend.authChainTimeStart && res.data.extend.authChainTimeEnd){
