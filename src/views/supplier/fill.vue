              ...
              <div class="search-base">
                ...
                <el-row>
                  <el-col :span="22">
                    ...
                    <el-col :span="18">
                      <el-form-item label="品类名称：" prop="supplier_name" class="supplierName">
                        <el-input
                          v-model="personalForm.supplier_name"
                          :readonly="true"
                          clearable
                          style="width:98.3%"
                          placeholder="水具，酒具，烹饪锅具，炒锅，碗碟套装等"
                        ></el-input>
                      </el-form-item>
                    </el-col>
                  </el-col>
                ...
                <el-row>
                  <el-col :span="22">
                    <el-form-item label="备注：" prop="note">
                      <el-input v-model="personalForm.note" style="width:100%" placeholder="请输入备注"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
              </div>
  ...
  data() {
    ...
    var checkSupplierName = (rule, value, callback) => {
      if (!value) {
        ...
        console.log(reg.test(value));
        if (reg.test(value)) {
          if(this.personalForm.oldSupplierName==this.personalForm.supplierName){
            callback();
          }else {
    ...
    return {
      ...
      personalRules: {
        ...
        order_wx: [
          { required: true, message: "请填写订单处理人微信", trigger: "blur" }
        ],
        order_email: [
  ...
  created() {
    ...
    if (this.$route.query.id) {
      ...
      supplierApplyPostByid(this.supplierId).then(res => {
        console.log(res)
        this.personalForm.oldSupplierName = res.data.supplierName;
        ...
        this.personalForm.department = res.data.contacts[0].department; //部门
        ...
        this.personalForm.generalManagerName =
          res.data.contacts[2].name; //总经理
        this.personalForm.generalManagerPhone =
          res.data.contacts[2].fixedPhone; //总经理手机号码
        this.personalForm.supplierPhone = res.data.supplierPhone; //公司电话
        this.personalForm.identify = res.data.extend.identify; //纳税人识别号
        this.personalForm.fax = res.data.extend.fax; //传真号码
        this.personalForm.generalManagerWechat =
          res.data.contacts[2].wechat; //总经理微信号
        this.personalForm.generalManagerEmail =
          res.data.contacts[2].email; //总经理邮箱
        this.personalForm.generalManagerFixedPhone =
          res.data.contacts[2].telephone; //总经理直线电话
        this.personalForm.bankName = res.data.extend.bankName; //开户行
        this.personalForm.bankAccount = res.data.extend.bankAccount; //开户账号
        this.personalForm.taxNumber = res.data.extend.taxNumber; //纳税人识别号
        ...
        this.personalForm.authorization.push(res.data.extend.authorizationTimeStart);//授权书开始有效期
        this.personalForm.authorization.push(res.data.extend.authorizationTimeEnd);//授权书结束有效期
        this.personalForm.trademarkTime.push(res.data.extend.trademarkTimeStart); //营业执照开始有效期
        this.personalForm.trademarkTime.push(res.data.extend.trademarkTimeEnd); //营业执照结束有效期
        this.personalForm.authChainTime.push(res.data.extend.authChainTimeStart); //授权链开始有效期
        this.personalForm.authChainTime.push(res.data.extend.authChainTimeEnd); //授权链结束有效期
        this.personalForm.authorizationChain1 = res.data.extend.authorizationChain.split(
          ","
        )[0]
          ? res.data.extend.authorizationChain.split("<:>")[0]
          : ""; //一级授权链
        this.personalForm.authorizationChain2 = res.data.extend.authorizationChain.split(
          "<:>"
        )[1]
          ? res.data.extend.authorizationChain.split("<:>")[1]
          : ""; //二级授权链
        this.personalForm.authorizationChain3 = res.data.extend.authorizationChain.split(
          "<:>"
        )[2]
          ? res.data.extend.authorizationChain.split("<:>")[2]
          : ""; //三级授权链
        this.personalForm.authorizationChain4 = res.data.extend.authorizationChain.split(
          "<:>"
        )[3]
          ? res.data.extend.authorizationChain.split("<:>")[3]
          : ""; //四级授权链
        this.personalForm.authorizationChain5 = res.data.extend.authorizationChain.split(
          "<:>"
        )[4]
          ? res.data.extend.authorizationChain.split("<:>")[4]
          : ""; //五级授权链
        this.personalForm.authorizationChain6 = res.data.extend.authorizationChain.split(
          "<:>"
        )[5]
          ? res.data.extend.authorizationChain.split("<:>")[5]
          : ""; //六级授权链
        this.personalForm.authorizationChain7 = res.data.extend.authorizationChain.split(
          "<:>"
        )[6]
          ? res.data.extend.authorizationChain.split("<:>")[6]
          : ""; //七级授权链
        this.personalForm.authorizationChain8 = res.data.extend.authorizationChain.split(
          "<:>"
        )[7]
