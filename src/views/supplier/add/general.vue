    ...
    <el-form :model="form" ref="form" :rules="rules" label-width="150px" size="small">
      <div class="mbottom">
        ...
        <el-form-item label="商品品牌：" prop="goods_branch">
          <el-select v-model="form.goods_branch" filterable remote  :remote-method="remoteMethod" placeholder="请选择商品品牌">
            <el-option
      ...
      <div class="mbottom">
        ...
        <el-form-item prop="first_image_id" label="上传商品图片：" class="upload-wrapper">
          ...
          <!-- <el-dialog > -->
            <!-- <div v-for="(item,index) in form.first_image_url" :key="index">
...
import { getTreecatagory , getBrand ,getUrlgoods , getIdgoodspec, getSpecification , savespecValues , saveSpecvalue , getIgoodsSpecvalue , addvalueTree} from '@/api/product/index'
