...
import { getTreecatagory , getBrand ,getUrlgoods , getIdgoodspec, getSpecification , savespecValues , saveSpecvalue} from '@/api/product/index'
...
export default {
  ...
  methods: {
    ...
    handleImageSuccess (res, file) {
      ...
      console.log(this.form.first_image_url)
    },
