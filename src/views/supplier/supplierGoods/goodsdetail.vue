                      ...
                      <span class="model">{{itemtent.specValue}}
                        <span class="delete-specif" @click="deleitem(itemtent,item)">
                          <span class="error">×</span>
                                    ...
                                    <el-button class="button-new-tag" size="small" type="primary" v-if="!item.show"
                                               @click="showInput(item,index)">添加
                                    </el-button>
                                    <el-select v-if="item.show" v-model='item.tent'
                                    ...
                                    <el-button class="button-new-tag" size="small" type="primary" v-if="item.show"
                                               @click="choice(item)">确定
                                    </el-button>
                                    <el-button class="button-new-tag" size="small" type="primary" v-if="item.show"
                                               @click='cancal(item)'>取消
                                    </el-button>
                                </div>
                            ...
                            <!-- <div><el-button type="primary"  class="button-new-tag" size="small" @click="addSpecification">添加规格</el-button></div> -->
                        </el-form-item>
                        <el-form-item prop="pricetable" label="价格列表：" class="reference">
                            <el-table :data="form.tableData" border style="width: 100%" stripe class="tableBox">
                                ...
                                <el-table-column prop="specValue" label="商品规格" align="center" width="200">
                                    <template slot-scope="scope">
                                        <span>32g</span>
                                    </template>
                                </el-table-column>
                    ...
                    <span class="el-dropdown-link">
                      ...
                      <img src="../../../common/images/sanjiao.png" alt="" style="width:10px;height:6px;">
                                            ...
                                            <el-dropdown-menu slot="dropdown">
                                                <el-dropdown-item @click.native='freightFunc(1)'>含税含运费
                                                </el-dropdown-item>
                                                <el-dropdown-item @click.native='freightFunc(2)'>含税不含运费
                                                </el-dropdown-item>
                                                <el-dropdown-item @click.native='freightFunc(3)'>不支持一件代发
                                                </el-dropdown-item>
                                            </el-dropdown-menu>
                                        </el-dropdown>
                                    </template>
                                    <template slot-scope="scope">
                                        ...
                                        <div v-if="scope.row.state == 2">
                                            <el-form-item :prop="'tableData.'+scope.$index+'.freight'"
                        ...
                        <el-form-item prop="offer" label="参考报价：" class="reference">
                            ...
                            <!-- </el-form>  -->
                            <!-- <el-table   :data="form.tableArr"  border style="width: 100%" stripe>
                              <el-table-column  prop=""  label="" align="center">
                                <template.vue slot-scope="scope">
                                      <el-input v-model="scope.row.date" placeholder="请输入内容"></el-input>
                                </template.vue>
                              </el-table-column>
                              <el-table-column  prop="name"  label="贵公司对外最低报价" align="center"></el-table-column>
                              <el-table-column  prop="name"  label="给我公司项目最低价" align="center"></el-table-column>
                              <el-table-column  prop="name"  label="京东价" align="center"></el-table-column>
                              <el-table-column  prop="name"  label="京东链接" align="center" ></el-table-column>
                              <el-table-column  prop="name"  label="天猫/淘宝价" align="center"></el-table-column>
                              <el-table-column  prop="name"  label="天猫/淘宝链接" align="center"></el-table-column>
                            </el-table> -->
                        </el-form-item>
                    </div>
                </div>
            ...
            <div class="mbottom">
                <div class="goods-fitter">
                    <div class="search-wrapper">
                                ...
                                <el-row style="display:flex">
                                    ...
                                    <el-col :span="24" class="bumber_col">
                                        <el-checkbox-group
                                            ...
                                            <el-checkbox v-for="data in item.children" :label="data.sceneId"
                                                         :key="data.sceneId">{{data.sceneName}}
                                            </el-checkbox>
                                        </el-checkbox-group>
                                    </el-col>
                                </el-row>
                            </el-form-item>
                            <!-- <el-row style="display:flex" class="square">
                                <div class="scenario">
                                  <div>节日类别：</div>
                                  <div class="number">(任选两个场景)</div>
                                </div>
                              <el-col :span="24"  class="bumber_col">
                                <el-checkbox-group
                                  v-model="holidaymodel"
                                  :max="2">
                                  <el-checkbox v-for="item in holiday" :label="item" :key="item">{{item}}</el-checkbox>
                                </el-checkbox-group>
                              </el-col>
                            </el-row>
                            <el-row style="display:flex"  class="square">
                              ...
                              <el-col :span="24" class="bumber_col">
                                <el-checkbox-group
                                  v-model="objectmodel"
                                  :max="2">
                                  <el-checkbox v-for="item in object" :label="item" :key="item">{{item}}</el-checkbox>
                                </el-checkbox-group>
                              </el-col>
                            </el-row>
                            <el-row style="display:flex"  class="square">
                                <div class="scenario">
                                  <div>为您推荐：</div>
                                  <div class="number">(任选一个场景)</div>
                                </div>
                              <el-col :span="24" class="bumber_col">
                                <el-checkbox-group
                                  v-model="recommendedmodel"
                                  :max="1">
                                  <el-checkbox v-for="item in recommended" :label="item" :key="item">{{item}}</el-checkbox>
                                </el-checkbox-group>
                              </el-col>
                            </el-row> -->
                        </el-form-item>
                        <el-form-item prop="first_image_id" label="上传商品图片：" class="upload-wrapper">
                            <el-input v-model="form.first_image_link" class="wh37" placeholder="商品图片URL"
                        ...
                        <el-form-item prop="warn_number" label="上传商品缩略图：" class="upload-wrapper">
                            <el-input v-model="form.first_image_link" class="wh37" placeholder="商品缩略图外部URL"
                                      style="margin-bottom:15px"></el-input>
                            <el-upload
                                    class="avatar-uploader"
                                    :action="action"
                                    :show-file-list="false"
                                    :on-success="handleImageSuccessmall"
                                    :before-upload="beforeImageUpload"
                            >
                                <img v-if="form.first_image_urlsmall" :src="form.first_image_urlsmall" class="avatar"/>
                                <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                            </el-upload>
                            <el-checkbox v-model="checked">自动生成缩略图</el-checkbox>
                        </el-form-item>
                    </div>
                </div>
            </div>
    ...
    export default {
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    specifications: [{required: true, message: '请选择规格', trigger: 'blur'}],
        ...
        methods: {
            ...
            handleImageSuccess(res, file) {
                this.form.first_image_url = res.data.domain + res.data.filePath
