<template>
    <div class="margin">
        <goods-fitter class="mbottom" @tabVender='handleGetGoodsList' :dataObj="form"
        ...
        <div class="mcard">
            <div class="mbottom">
                ...
                <el-button type="primary" size="small" @click="$router.push({  name: 'ProductAdd'}) " v-if="false">
                    添加商品
                </el-button>
            </div>
            <el-table
            ...
            >
                ...
                <el-table-column label="价格信息" align="center" width="150">
                    <template slot-scope="scope">
                        <div
                                class="txt_left"
                        >商城价：{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice !=
                            0?scope.row.skuInfo[scope.row.index].priceInfo.goodsPrice:''}}
                        </div>
                        <div
                                class="txt_left"
                        >市场价：{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice !=
                            0?scope.row.skuInfo[scope.row.index].priceInfo.marketPrice:''}}
                        </div>
                        <div
                                class="txt_left"
                        >税率：{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice !=
                            0?scope.row.skuInfo[scope.row.index].priceInfo.taxRate+'%':''}}
                        </div>
                        <div class="txt_left">
                            一件代发价：
                            <span
                        ...
                        <div
                                class="txt_left"
                        >运费：{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice !=
                            0?scope.row.skuInfo[scope.row.index].priceInfo.carriagePrice:''}}
                        </div>
                        <div
                                class="txt_left"
                        >京东价：{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice !=
                            0?scope.row.skuInfo[scope.row.index].priceInfo.jdPrice:''}}
                        </div>
                        <div
                                class="txt_left"
                        >{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice !=
                            0?scope.row.skuInfo[scope.row.index].priceInfo.shopPrice:''}}
                        </div>
                        <div
                                class="txt_left"
                        >{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice !=
                            0?scope.row.skuInfo[scope.row.index].priceInfo.price:''}}
                        </div>
                        <div
                                class="txt_left"
                        >市场价对比京东折扣率：{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice !=
                            0?scope.row.skuInfo[scope.row.index].priceInfo.costJdRatio:''}}
                        </div>
                        <div
                                class="txt_left"
                        >商城价对比京东折扣率：{{scope.row.skuInfo[scope.row.index].priceInfo.costPrice !=
                            0?scope.row.skuInfo[scope.row.index].priceInfo.shopJdRatio:''}}
                        </div>
                    </template>
                </el-table-column>
                    ...
                    <template slot-scope="scope">
                        ...
                        <div class="line-div small_top">
                            <div class="small-Idiv">
                                ...
                                <span style="word-break: keep-all;margin-left: 5px;left:10px"
                                      class="spanclass">一件代发</span>
                            </div>
                            <el-switch
                ...
                <el-form :model="form" label-width="150px">
                    ...
                    <el-form-item label="商品操作：">
                        <el-checkbox-group v-model="checkList2" @change='operating'>
                            <el-checkbox :label="item.value" v-for="item in goods" :key="item.name"
                                         :disabled='item.show'>{{item.name}}
                            </el-checkbox>
                        </el-checkbox-group>
                    </el-form-item>
                </el-form>
