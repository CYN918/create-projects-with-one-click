  ...
  <div class="margin">
    ...
    <div class="mcard">
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        <el-table-column  prop="name"  label="报价单状态" align="center"></el-table-column>
        <el-table-column  prop="name"  label="报价单信息" align="center"></el-table-column>
        <el-table-column  prop="name"  label="客户信息" align="center"></el-table-column>
        <el-table-column  prop="name"  label="发票信息" align="center"></el-table-column>
        <el-table-column  prop="name"  label="报价单位信息" align="center" ></el-table-column>
     ...
     <div class="mcard" style="margin-top:20px">
      ...
      <el-table   :data="tableData"  border style="width: 100%" stripe>
        ...
        <el-table-column  prop="name"  label="广告说明" align="center"></el-table-column>
