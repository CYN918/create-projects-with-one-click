               ...
               <el-col :span="5">
                    <el-col>
                        <el-form-item label="审批状态：">
                            <el-col :span="21">
                              <el-select v-model="form.approvalType" placeholder="除已生成采购订单之外">
          ...
          <template>
            <div class="line-div">
              ...
              >
                ...
                <span style="word-break: keep-all;">通过</span>
              </div>
            </div>
            <div class="line small_top">
              <div
                ...
                style="justify-content: end;margin-left:8px;"
                v-show="form.auditStatus!=1"
              >
                <div class="i-div">
                  <img src="@/common/images/icon/历史采购.png" alt class="operation_img" />
                </div>
                <span style="word-break: keep-all;">历史采购</span>
              </div>
              <div
                class="small-Idiv"
                @click="_throughSupplieraudit()"
                style="justify-content: end;margin-left:12px;margin-right:24px"
                v-show="form.auditStatus!=1"
              >
                <div class="i-div">
                  <img src="@/common/images/icon/历史报价.png" alt class="operation_img" />
                </div>
                <span style="word-break: keep-all;">历史报价</span>
              </div>
