  ...
  <div class="margin0">
    <div class="mcard" style="border:1px solid #d7e0f1">
      <el-table :data="pageList" border @selection-change="handleSelectionChange" stripe>
       ...
       <el-table-column label="规格尺寸" prop="name" align="center" width="100">
                  <template slot-scope="scope">
                        {{scope.row.specSize}}
                  </template>
        </el-table-column>
        ...
        <el-table-column label="库存" prop="name" align="center" width="60">
                 <template slot-scope="scope">
        ...
        <el-table-column label="订购数量" prop="name" align="center" width="80">
                  <template slot-scope="scope">
                       {{scope.row.goodsCount}}
                  </template>
        </el-table-column>
        <el-table-column label="出货数量" prop="name" align="center" width="200">
                  <template slot-scope="scope">
                       ...
                       <div class="txt_left">本次出货数量： {{scope.row.shipmentQuantity}}</div>
                  </template>
        </el-table-column>
        ...
        <el-table-column label="税费" prop="name" align="center" width="80">
                  <template slot-scope="scope">
                       {{scope.row.taxation}}
                  </template>
        </el-table-column>
        ...
        <el-table-column label="制作要求" prop="name" align="center" width="100">
                    <template slot-scope="scope">
                        {{scope.row.productionRequire}}
                  </template>
        </el-table-column>
        <el-table-column label="交货日期" prop="name" align="center" width="80">
                     <template slot-scope="scope">
  ...
  computed: {
      ...
      if(_this.pageList.length>0){
          for(var i = 0;i<_this.pageList.length;i++){
            if(!isNaN(_this.pageList[i].totalPrice)){
