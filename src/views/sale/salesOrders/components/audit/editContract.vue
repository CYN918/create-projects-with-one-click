              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item label="合同生效后：" prop="payLimitDay">
                    <el-col :span="16">
                      <el-input-number
                        v-model.number="detailData1.payLimitDay"
...
export default {
  ...
  methods: {
    ...
    editSave() {
      ...
      obj.aemail = this.detailData1.aemail;
      ...
      obj.bemail = this.detailData1.bemail;
    ...
    addCompany(row) {
      ...
      this.detailData1.aemail =
        this.companyData[0] && this.companyData[0].sccEmail;
