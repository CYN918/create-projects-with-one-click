<template>
    <div id="addPurchasing">
        ...
        <div class="mbottom">
          <div class="goods-fitter">
            <el-form ref="infoForm" :model="OrderData" :rules="rules" label-width="140px" size="small">
              <div class="search-wrapper">
                <div class="mbottom">
                ...
                <div class="search-base">
                  ...
                  <el-row>
                      ...
                      <el-col :span="8">
                        <el-form-item label="送 货 员：" prop="transportMode">
                          <el-col :span="19">
                            <el-input v-model="OrderData.deliveryUserName"  v-if="userList.length<1" readonly></el-input>
                            <el-select v-model="form.deliveryUserId" placeholder="请选择" v-if="userList.length>=1"
        ...
        <div class="goods-fitter">
          ...
          <div class="mail-fitter" style="margin-top:20px">
            <el-form ref="infoForm" :model="OrderData" :rules="rules" label-width="100px" size="small">
...
import {saveOutOrder} from "@/api/sale/index"
...
export default {
  components: {
    ...
    props:["addVisibles","outOrderData","ruleForm",'options1'],
    watch: {
    addVisibles(val) {
      this.addVisible = val;
        },
    ...
    //监听组织架构
        "ruleForm.organizeId":{
          handler(val){
            this.userList = [];
            this.OrderData.deliveryUserName = '';
            this.OrderData.deliveryUserId ="";
            if(val){
              let data ={};
              data.organizeId = val;
    ...
    computed: {
      ...
      if(_this.OrderData.details&&_this.OrderData.details.length>0){
          for(var i = 0;i<_this.OrderData.details.length;i++){
            if(_this.OrderData.details[i].totalPrice){
    ...
    //生成出货单
    saveOrder(){
      this.OrderData.deliveryUserId  = this.form.deliveryUserId;
      saveOutOrder(this.OrderData).then(res=>{
            if(res.code===200){
              throttleTipPop(this, "success", "生成出货单成功", 2000);
              this.addVisible =false;
     ...
     //筛选出下拉表的label值
      chooseWarehousingUser(data){
        ...
        this.OrderData.deliveryUserName = obj.sysuserName;
