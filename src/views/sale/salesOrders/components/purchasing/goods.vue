    ...
    <div class="mcard" style="border:1px solid #d7e0f1">
      <el-table :data="inPage" border @selection-change="handleSelectionChange" stripe>
        <el-table-column label="序号" type="index" align="center" width="50">
         ...
         <el-table-column label="图样" prop="name" align="center" width="95">
        ...
        <el-table-column label="规格尺寸" prop="name" align="center" width="115">
                <template slot-scope="scope">
        ...
        <el-table-column label="数量" prop="name" align="center">
         ...
         <el-table-column label="税额" prop="name" align="center">
              <template slot-scope="scope">
                    {{scope.row.tax}}
              </template>
        </el-table-column>
        <el-table-column label="含税单价" prop="name" align="center">
         ...
         <el-table-column label="合计" prop="name" align="center">
          ...
          <el-table-column label="制作要求" prop="name" align="center" width="180">
              <template slot-scope="scope">
          ...
          <el-table-column label="交货日期 " prop="name" align="center">
           ...
           <el-table-column label="收货地址" prop="name" align="center" width="170">
                  <template slot-scope="scope">
          ...
          <div class="total" style="margin-left:51%;margin-top:20px">
...
import {getProjectOrderGoods} from '@/api/sale/index'
export default {
  data () {
    return {
      spoId:'',
