<template>
    <div id="addContract">
      <el-dialog width="75%" :visible.sync="contractVisible" :before-close="createClosing">
                  ...
                  <div class="mbottom">
                    <div class="goods-fitter">
                      <div class="mcard" style="padding-bottom:0">
                        <el-table :data="proList.goodsDetailListVo" border style="width: 100%" stripe>
                          ...
                          <el-table-column prop="customerType" label="产品名称" align="center" width="150">
                                   <template slot-scope="scope">
                                        {{scope.row.goodsName}}
                                  </template>
                          </el-table-column>
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="合同生效后：" prop="payLimitDay">
                      <el-col :span="16">
                        <el-input-number
                          v-model.number="proList.payLimitDay"
                      ...
                      <span style="margin-left:20px;">日内支付</span> 
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                 ...
                 <el-row>
                  <el-col :span="22">   
                   <el-form-item label="发票项目内容：">
                    <el-input v-model="proList.invoiceContent"></el-input>
                   </el-form-item>
                  </el-col>
                </el-row>
...
import {getOrderGoods,createContract,uploadFileDesignDraftUrl} from "@/api/sale/index"
...
export default {
    data(){
        ...
        return{
            ...
            tableData: [],
                ...
                payLimitDay: [{  validator: checkDay,  required: true, trigger: ["blur","change"] }],
                bankAccount: [
                { required: true, message: "此项为必选项", trigger: ["blur","change"] }
                ],
                bankName: [
    ...
    computed: {
      ...
      let totals = 0
      let _this = this
      if(_this.proList.goodsDetailListVo&&_this.proList.goodsDetailListVo.length>0){
          for(var i = 0;i<_this.proList.goodsDetailListVo.length;i++){
            if(!isNaN(_this.proList.goodsDetailListVo[i].totalPrice)){
              totals+=parseFloat(_this.proList.goodsDetailListVo[i].totalPrice)
            }else{
              totals = 0
            }
      }
 ...
 /*        this.proList.partyAId = this.companyData[0]&&this.companyData[0].sccId; */
    ...
    //保存生成合同 
    createSave(){
      this.proList.orderId = this.proList.businessId;
    ...
    handleAvatarSuccess(file) {
            ...
            this.proList.goodsDetailListVo[this.upLoadIndex].fileDesignDraftUrl = file.data.domain + file.data.filePath; 

            let obj = {};
            obj.fileDesignDraftUrl = this.proList.goodsDetailListVo[this.upLoadIndex].fileDesignDraftUrl;
            obj.sordId = this.proList.goodsDetailListVo[this.upLoadIndex].sordId;
