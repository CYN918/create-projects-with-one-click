  ...
  <div class="margin0">
    <div class="mcard" style="border:1px solid #d7e0f1">
      <el-table :data="pageList" border @selection-change="handleSelectionChange" stripe>
        ...
        <el-table-column label="税率" prop="name" align="center" width="150" >
                    <template slot-scope="scope">
                        {{scope.row.taxRate}}
                  </template>
        </el-table-column>
        <el-table-column label="制作要求" prop="name" align="center" width="230">
                    <template slot-scope="scope">
...
import {getInvoiceGoodsList} from '@/api/sale/index';
export default {
  data () {
    return {
      pageList:[],
