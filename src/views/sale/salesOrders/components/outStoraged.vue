...
import {getOutStorageList} from '@/api/sale/index'
import Goods from './outStoraged/goods'
import All from './outStoraged/all'
import Today from './outStoraged/today'
import Three from './outStoraged/three'
import Seven from './outStoraged/seven'
export default {
  data () {
    return {
      storeData:[],
