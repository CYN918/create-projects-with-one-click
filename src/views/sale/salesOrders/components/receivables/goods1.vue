  ...
  <div class="margin0">
      ...
      <el-table :data="pageList" border @selection-change="handleSelectionChange" stripe>
        ...
        <el-table-column label="操作" align="center" fixed="right" width="80">
          <template slot-scope="scope">
              ...
              <div class="small-Idiv" @click="deletePay(scope.row)"
              v-permit="'SaleOrder:delete_pay'">
                <div class="i-div">
    ...
    <el-dialog :visible.sync="deleteVisible" width="20%" title="提示" style="top:20%">
        ...
        <span slot="footer" class="dialog-footer">
          ...
          >取 消</el-button>
          <el-button type="primary" @click="deletePayNote()" size="small">确 定</el-button>
        </span>
      </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
      ...
      deletePayNote(){
          deletePayId(this.payId).then(res=>{
            if(res.code===200){
              this.$message.success("删除收款记录成功");
