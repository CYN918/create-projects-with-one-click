        ...
        <div class="mcard" style="border:1px solid #d7e0f1">
          <div class="header">
            ...
            <el-button
              ...
              v-print="'#printTest'"
            >打印</el-button>
            <el-button class="operate" type="primary" size="small">导出PDF</el-button>
          </div>
          <div id="printTest">
            <el-form ref="infoForm" :model="form" :rules="rules" label-width="140px" size="small">
              <div class="look">
                <div class="outTitle">
                  <h1 style="text-align:center;font-size:30px;margin:50px 0;">出库单</h1>
                </div>
                <el-row>
                  <el-col :span="8">
                    <el-col>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item label="运输方式：">
                      <el-col :span="19">
                        <el-input v-model="deliveryData.transportType" readonly
...
import {getDeliverDetail} from '@/api/sale/index'
export default {
  name: "OrderOut",
  data() {
    return {
  ...
  methods: {
    ...
    //出库单详情
    _getDeliverDetail(){
        getDeliverDetail(this.$route.query.id).then(res=>{
          if(res.code===200){
