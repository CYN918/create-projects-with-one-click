  ...
  <div class="margin0">
    <div class="mcard" style="border:1px solid #d7e0f1">
      <el-table :data="pageList" border @selection-change="handleSelectionChange" stripe>
       ...
       <el-table-column label="规格尺寸" prop="name" align="center" >
                    <template slot-scope="scope">
                        {{scope.row.specSize}}
                  </template>
        </el-table-column>
        ...
        <el-table-column label="出货数量" prop="name" align="center" width="200">
                  <template slot-scope="scope">
                       <div class="txt_left">已出货数量：{{scope.row.shippedQuantity}}</div>
                       <div class="txt_left">未出货数量：{{scope.row.unreleasedQuantity}}</div>
                       <div class="txt_left">本次出货数量： {{scope.row.thisQuantity}}</div>
                  </template>
        </el-table-column>
        ...
        <el-table-column label="收货信息" prop="name" align="center">
                       <template slot-scope="scope">
                       <div class="txt_left">联系人：无</div>
                       <div class="txt_left">电话：无</div>
                       <div class="txt_left">地址：无</div>
                  </template>
        </el-table-column>
        <el-table-column label="物流信息" prop="name" align="center" width="140">
                    <template slot-scope="scope">
                        <div class="txt_left">物流公司：无</div>
                       <div class="txt_left">物流单号：无</div>
                       <div class="txt_left">运费：无</div>
                       <div class="txt_left">日期：无</div>
                  </template> 
        </el-table-column>
        
      </el-table>
      <div class="total" style="margin-left:67%;margin-top:20px">
