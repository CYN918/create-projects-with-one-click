     ...
     <div class="margin">
      <div class="tabs-header">
        <ul class="clearfix">
            ...
            <li class ="link" @click="tabIndex0(0)"  :class="currentIndex0===0 ? 'active' : ''">询价单</li>
  
            <li class ="link" @click="tabIndex0(1)"  :class="currentIndex0===1 ? 'active' : ''">待生成报价单</li>
     
            <li class ="link" @click="tabIndex0(2)"  :class="currentIndex0===2 ? 'active' : ''">报价单</li>
...
import Inquirys from './inquirys/index'
...
export default {
  ...
  methods: {
    ...
    tabIndex0 (index) {
      ...
      switch(index) {
        case 0:
          this.comIndex = 'Inquirys'
          break;
        case 1:
          this.comIndex = 'Offer'
          break;
        case 2:
          this.comIndex = 'Pending'
          break;
