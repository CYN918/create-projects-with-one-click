  ...
  <div class="margin0">
    <div class="mcard" style="border:1px solid #d7e0f1">
      <el-table :data="pageList" border @selection-change="handleSelectionChange" stripe>
        ...
        <el-table-column label="商品信息" prop="name" align="center" width="280">
                <template slot-scope="scope">
       ...
       <el-table-column label="规格尺寸" prop="name" align="center" width="166">
                  <template slot-scope="scope">
                        {{scope.row.goodsSpecSize}}
                  </template>
        </el-table-column>
        <el-table-column label="税率" prop="name" align="center" width="110">
                  <template slot-scope="scope">
                        {{scope.row.taxRate}}
                  </template>
        </el-table-column>
        ...
        <el-table-column label="含税单价" prop="name" align="center" width="120">
                  <template slot-scope="scope">
                      {{scope.row.goodsPrice}}
                  </template>
        </el-table-column>
        <el-table-column label="合计" prop="name" align="center" width="120">
                    <template slot-scope="scope">
      ...
      <div class="total" style="margin-left:78%;margin-top:20px">
...
<script>
import {contractGoods} from "@/api/sale/index";
export default {
  data () {
    return {
      saleOrderNo:'',
