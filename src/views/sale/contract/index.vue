                ...
                <el-col :span="5">
                  <el-col>
                    <el-form-item label="客户名称：">
                        <el-col :span="21">
                            <el-input v-model="form.bbCompanyName" placeholder="请输入客户名称"></el-input>
                        </el-col>
                    </el-form-item>
                  </el-col>
                </el-col>
                <el-col :span="5">
                  <el-col>
                    <el-form-item label="签单公司：">
                        <el-col :span="21">
                            <el-input v-model="form.aaCompanyName" placeholder="请输入签单公司"></el-input>
                        </el-col>
                    </el-form-item>
                  </el-col>
                </el-col>
                ...
                <el-col :span="5">
                  <el-col>
                    <el-form-item label="销售单号：">
                        <el-col :span="21">
                            <el-input v-model="form.businessNo" placeholder="请输入销售单号"></el-input>
                        </el-col>
                    </el-form-item>
                  </el-col>
                </el-col>
  ...
  <div class="mcard0">
      ...
      <el-table   :data="page"  border style="width: 100%" 
        ...
        <el-table-column  prop="name"  label="状态" align="center" width="100 ">
              <template slot-scope="scope">
                    <div  v-html="scope.row.status" style="text-align:center"></div>
              </template>
        </el-table-column>
        ...
        <el-table-column  prop="name"  label="业务单号" align="center" width="190">
              <template slot-scope="scope">
                    <div class="txt_left">销售单号：{{scope.row.businessNo}}</div>
        ...
        <el-table-column  prop="name"  label="收款账号信息" align="center" width="252">
              <template slot-scope="scope">
        ...
        <el-table-column  prop="name"  label="销售员" align="center">
              <template slot-scope="scope">
                    {{scope.row.bizUserName}}
              </template>
        </el-table-column>
    ...
    <div class="margin0" style="margin-top:20px">
            ...
            <div class="tabs-content">
              <component :is="mainIndex" :goodsList="goodsList" :count="count" :showNo="showNo"></component>
...
import {getContract,contractGoods} from "@/api/sale/index"
export default {
  data () {
    return {
      currentIndex:0,
  ...
  methods: {
      _getContract(){
        getContract(this.form).then(res=>{
      ...
      look(row){
        this.$router.push({name:'Preview',query:{id:row.contractId}})
      },
      //选择改变列背景颜色
      ...
      AhandleSelectionChange(row) {
        ...
        this.showNo = row.businessNo;
        let obj={};
        obj.pageSize = this.goodsData.pageSize;
        obj.pageIndex = this.goodsData.pageIndex;
        obj.saleOrderNo =row.businessNo;
        contractGoods(obj).then(res=>{
