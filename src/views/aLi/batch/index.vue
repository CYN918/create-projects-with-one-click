						...
						<div class="goods-fitter">
								<el-form label-width="260px" size="small">
										<div class="search-wrapper">
												...
												<div class="introduce">3、商品ID是阿里商品链接里https://item.jd.com/11320871935.htm的一串数字</div>
										</div>
								</el-form>
						</div>
				</div>
		                         ...
		                         <span class="gaunjianzi">(在数字前面写[ + - * / ]表示算法，如原价调高1.2倍写成*1.2)</span>
												...
												<el-form-item>
														<el-button type="primary" size="small" @click="postData"
																			 v-loading.fullscreen.lock="fullscreenLoading" element-loading-text="采集中,请稍后~">
																立刻采集
														</el-button>
												</el-form-item>
										</div>
...
<script>
    ...
    import {aLiDataCollect, getTreecatagory, getType} from '@/api/product/index'
