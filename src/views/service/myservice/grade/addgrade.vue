						...
						<ul class="list">
								<li class="item" v-for="(item1, index1) in list"
										...
										<div class="item_one">
												...
												<el-button class="word_two">升级会员服务</el-button>
										</div>
										<div>
												<el-button class="word_three" @click="cancel()">还原</el-button>
...
<script>
    import {addGradeList} from "@/api/service";
    export default {
        data() {
            return {
                text:"服务中心>我的服务>等级管理>新增等级",
                list: [
                    {
                        "id": "",
                        "gradeNo": 2,
        ...
        methods: {
            getList() {
                this.origin_data = JSON.parse(JSON.stringify(this.list));
            },
            //编辑提交
            submitData(item) {
                //编辑状态
            ...
            cancel() {
                if (this.addEdit) {
                    this.$set(this.list, 0, this.origin_data[0])
										this.getList()
                    this.$message('恢复原始值');
                }
