...
<script>
    import {confirmpurchaseData, submitPayData,getEventState, goPayData} from "@/api/service";
    ...
    export default {
        ...
        methods: {
	        ...
	        startQueryOrderTimer(func, time=3000) {
		        this.clearTimer();
            ...
            submitPay() {
                ...
                submitPayData(obj).then(res => {
                    if (res.code == 200) {
						...
						this.startQueryOrderTimer(this.payStatus);
                    }
                })
            },
			//去支付
            ...
            refreshQ () {
				...
				this.refresh = false
                //继续支付
                this.goPay(this.orderNo, this.payType);
            },
            approvalSaveRe (){
                let obj={}
                obj.gradeNo=this.gradeNo
