...
<script>
    import {getGradeList, editGradeList, addGradeList, deleteGrade} from "@/api/service";
    ...
    export default {
        ...
        methods: {
            ...
            addGrade() {
                this.addEdit = false
                this.$set(this.list, this.list.length, this.addlist[0])
                this.$set(this.list[this.list.length - 1], "seen", true);
            ...
            submitData(item) {
                ...
                if (this.addEdit) {
                    ...
                    console.log(222, this.list.length)
                    //添加状态
                    var obj2 = JSON.parse(JSON.stringify(this.list[this.list.length - 1]));
                    addGradeList(obj2).then(res => {
                        if (res.code == 200) {
                            this.$message({
                                message: res.message,
                                type: "success"
